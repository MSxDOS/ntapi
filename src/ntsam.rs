...
STRUCT! {#[debug] struct SAM_RID_ENUMERATION {
    RelativeId: ULONG,
    Name: UNICODE_STRING,
}}
pub type PSAM_RID_ENUMERATION = *mut SAM_RID_ENUMERATION;
STRUCT! {#[debug] struct SAM_SID_ENUMERATION {
    Sid: PSID,
    Name: UNICODE_STRING,
}}
pub type PSAM_SID_ENUMERATION = *mut SAM_SID_ENUMERATION;
STRUCT! {#[debug] struct SAM_BYTE_ARRAY {
    Size: ULONG,
    Data: PUCHAR,
}}
pub type PSAM_BYTE_ARRAY = *mut SAM_BYTE_ARRAY;
STRUCT! {#[debug] struct SAM_BYTE_ARRAY_32K {
    Size: ULONG,
    Data: PUCHAR,
}}
...
STRUCT! {#[debug] #[repr(packed(4))] struct DOMAIN_GENERAL_INFORMATION {
...
STRUCT! {#[debug] #[repr(packed(4))] struct DOMAIN_GENERAL_INFORMATION2 {
...
STRUCT! {#[debug] struct DOMAIN_UAS_INFORMATION {
    UasCompatibilityRequired: BOOLEAN,
}}
...
STRUCT! {#[debug] struct DOMAIN_DISPLAY_USER {
    Index: ULONG,
    Rid: ULONG,
...
STRUCT! {#[debug] struct DOMAIN_DISPLAY_MACHINE {
    Index: ULONG,
    Rid: ULONG,
    AccountControl: ULONG,
...
STRUCT! {#[debug] struct DOMAIN_DISPLAY_GROUP {
    Index: ULONG,
    Rid: ULONG,
    Attributes: ULONG,
...
STRUCT! {#[debug] struct DOMAIN_DISPLAY_OEM_USER {
    Index: ULONG,
    User: OEM_STRING,
}}
pub type PDOMAIN_DISPLAY_OEM_USER = *mut DOMAIN_DISPLAY_OEM_USER;
STRUCT! {#[debug] struct DOMAIN_DISPLAY_OEM_GROUP {
    Index: ULONG,
    Group: OEM_STRING,
}}
...
STRUCT! {#[debug] struct DOMAIN_LOCALIZABLE_ACCOUNT_ENTRY {
    Rid: ULONG,
    Use: SID_NAME_USE,
    Name: UNICODE_STRING,
    AdminComment: UNICODE_STRING,
...
STRUCT! {#[debug] struct DOMAIN_LOCALIZABLE_ACCOUNTS_BASIC {
    Count: ULONG,
...
STRUCT! {#[debug] struct GROUP_MEMBERSHIP {
    RelativeId: ULONG,
    Attributes: ULONG,
}}
...
STRUCT! {#[debug] struct GROUP_GENERAL_INFORMATION {
    Name: UNICODE_STRING,
    Attributes: ULONG,
    MemberCount: ULONG,
    AdminComment: UNICODE_STRING,
...
STRUCT! {#[debug] struct GROUP_NAME_INFORMATION {
    Name: UNICODE_STRING,
}}
pub type PGROUP_NAME_INFORMATION = *mut GROUP_NAME_INFORMATION;
STRUCT! {#[debug] struct GROUP_ATTRIBUTE_INFORMATION {
    Attributes: ULONG,
}}
pub type PGROUP_ATTRIBUTE_INFORMATION = *mut GROUP_ATTRIBUTE_INFORMATION;
STRUCT! {#[debug] struct GROUP_ADM_COMMENT_INFORMATION {
    AdminComment: UNICODE_STRING,
}}
...
STRUCT! {#[debug] struct ALIAS_GENERAL_INFORMATION {
    Name: UNICODE_STRING,
    MemberCount: ULONG,
    AdminComment: UNICODE_STRING,
}}
pub type PALIAS_GENERAL_INFORMATION = *mut ALIAS_GENERAL_INFORMATION;
STRUCT! {#[debug] struct ALIAS_NAME_INFORMATION {
    Name: UNICODE_STRING,
}}
pub type PALIAS_NAME_INFORMATION = *mut ALIAS_NAME_INFORMATION;
STRUCT! {#[debug] struct ALIAS_ADM_COMMENT_INFORMATION {
    AdminComment: UNICODE_STRING,
}}
...
STRUCT! {#[debug] struct ALIAS_EXTENDED_INFORMATION {
    WhichFields: ULONG,
...
STRUCT! {#[debug] struct USER_GENERAL_INFORMATION {
...
STRUCT! {#[debug] struct USER_PREFERENCES_INFORMATION {
    UserComment: UNICODE_STRING,
...
STRUCT! {#[debug] struct USER_PARAMETERS_INFORMATION {
    Parameters: UNICODE_STRING,
}}
pub type PUSER_PARAMETERS_INFORMATION = *mut USER_PARAMETERS_INFORMATION;
STRUCT! {#[debug] #[repr(packed(4))] struct USER_LOGON_INFORMATION {
    UserName: UNICODE_STRING,
    FullName: UNICODE_STRING,
    UserId: ULONG,
    PrimaryGroupId: ULONG,
...
STRUCT! {#[debug] #[repr(packed(4))] struct USER_ACCOUNT_INFORMATION {
    UserName: UNICODE_STRING,
    FullName: UNICODE_STRING,
    UserId: ULONG,
    PrimaryGroupId: ULONG,
...
STRUCT! {#[debug] struct USER_EXTENDED_INFORMATION {
...
STRUCT! {#[debug] struct SAM_GROUP_MEMBER_ID {
    MemberRid: ULONG,
}}
pub type PSAM_GROUP_MEMBER_ID = *mut SAM_GROUP_MEMBER_ID;
STRUCT! {#[debug] struct SAM_ALIAS_MEMBER_ID {
    MemberSid: PSID,
}}
...
STRUCT! {#[debug] struct SAM_VALIDATE_PASSWORD_HASH {
    Length: ULONG,
    Hash: PUCHAR,
}}
...
STRUCT! {#[debug] struct SAM_VALIDATE_PERSISTED_FIELDS {
    PresentFields: ULONG,
    PasswordLastSet: LARGE_INTEGER,
...
STRUCT! {#[debug] struct SAM_VALIDATE_STANDARD_OUTPUT_ARG {
...
STRUCT! {#[debug] struct SAM_VALIDATE_AUTHENTICATION_INPUT_ARG {
...
STRUCT! {#[debug] struct SAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
...
STRUCT! {#[debug] struct SAM_VALIDATE_PASSWORD_RESET_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
    ClearPassword: UNICODE_STRING,
    UserAccountName: UNICODE_STRING,
    HashedPassword: SAM_VALIDATE_PASSWORD_HASH,
...
STRUCT! {#[debug] struct SAM_OPERATION_OBJCHG_INPUT {
    Register: BOOLEAN,
    EventHandle: ULONG64,
    ObjectType: SECURITY_DB_OBJECT_TYPE,
    ProcessID: ULONG,
...
STRUCT! {#[debug] struct SAM_OPERATION_OBJCHG_OUTPUT {
    Reserved: ULONG,
}}
