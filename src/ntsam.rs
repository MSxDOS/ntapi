...
use crate::{
    ctypes::{__uint64, c_uchar, c_ulong, c_ushort, c_void, wchar_t},
    string::UTF8Const,
...
pub type PSAM_HANDLE = *mut *mut c_void;
pub type SAM_HANDLE = *mut c_void;
pub type SAM_ENUMERATE_HANDLE = c_ulong;
pub type PSAM_ENUMERATE_HANDLE = *mut c_ulong;
...
pub const SAM_SERVER_CONNECT: c_ulong = 0x0001;
pub const SAM_SERVER_SHUTDOWN: c_ulong = 0x0002;
pub const SAM_SERVER_INITIALIZE: c_ulong = 0x0004;
pub const SAM_SERVER_CREATE_DOMAIN: c_ulong = 0x0008;
pub const SAM_SERVER_ENUMERATE_DOMAINS: c_ulong = 0x0010;
pub const SAM_SERVER_LOOKUP_DOMAIN: c_ulong = 0x0020;
pub const SAM_SERVER_ALL_ACCESS: c_ulong = STANDARD_RIGHTS_REQUIRED
    | SAM_SERVER_CONNECT
...
pub const SAM_SERVER_READ: c_ulong =
    STANDARD_RIGHTS_READ | SAM_SERVER_ENUMERATE_DOMAINS;
pub const SAM_SERVER_WRITE: c_ulong = STANDARD_RIGHTS_WRITE
    | SAM_SERVER_INITIALIZE
    | SAM_SERVER_CREATE_DOMAIN
    | SAM_SERVER_SHUTDOWN;
pub const SAM_SERVER_EXECUTE: c_ulong =
...
pub const DOMAIN_ALL_ACCESS: u32 = STANDARD_RIGHTS_REQUIRED
...
pub const DOMAIN_READ: u32 = STANDARD_RIGHTS_READ
    | DOMAIN_GET_ALIAS_MEMBERSHIP
    | DOMAIN_READ_OTHER_PARAMETERS;
pub const DOMAIN_WRITE: u32 = STANDARD_RIGHTS_WRITE
    | DOMAIN_WRITE_OTHER_PARAMETERS
    | DOMAIN_WRITE_PASSWORD_PARAMS
    | DOMAIN_CREATE_USER
    | DOMAIN_CREATE_GROUP
    | DOMAIN_CREATE_ALIAS
    | DOMAIN_ADMINISTER_SERVER;
pub const DOMAIN_EXECUTE: u32 = STANDARD_RIGHTS_EXECUTE
    | DOMAIN_READ_PASSWORD_PARAMETERS
    | DOMAIN_LIST_ACCOUNTS
    | DOMAIN_LOOKUP;
...
STRUCT! {#[repr(packed(4))] struct DOMAIN_GENERAL_INFORMATION {
    ...
    UasCompatibilityRequired: c_uchar,
    UserCount: c_ulong,
    GroupCount: c_ulong,
    AliasCount: c_ulong,
}}
...
pub type PDOMAIN_LOCALIZABLE_ACCOUNTS_INFORMATION =
    *mut DOMAIN_LOCALIZABLE_ACCOUNTS_INFORMATION;
...
pub type PDOMAIN_LOCALIZABLE_ACCOUNT_ENTRY =
    *mut DOMAIN_LOCALIZABLE_ACCOUNT_ENTRY;
STRUCT! {struct DOMAIN_LOCALIZABLE_ACCOUNTS_BASIC {
    Count: c_ulong,
    Entries: *mut DOMAIN_LOCALIZABLE_ACCOUNT_ENTRY,
}}
pub type PDOMAIN_LOCALIZABLE_ACCOUNTS_BASIC =
    *mut DOMAIN_LOCALIZABLE_ACCOUNTS_BASIC;
UNION! {union DOMAIN_LOCALIZABLE_ACCOUNTS_INFO_BUFFER {
    Basic: DOMAIN_LOCALIZABLE_ACCOUNTS_BASIC,
}}
pub type PDOMAIN_LOCALIZABLE_ACCOUNTS_INFO_BUFFER =
    *mut DOMAIN_LOCALIZABLE_ACCOUNTS_INFO_BUFFER;
EXTERN! {extern "system" {
    ...
    fn SamEnumerateDomainsInSamServer(
        ...
        PreferedMaximumLength: c_ulong,
        CountReturned: *mut c_ulong,
    ) -> NTSTATUS;
    fn SamOpenDomain(
        ServerHandle: SAM_HANDLE,
        DesiredAccess: c_ulong,
...
pub const GROUP_READ_INFORMATION: c_ulong = 0x0001;
pub const GROUP_WRITE_ACCOUNT: c_ulong = 0x0002;
pub const GROUP_ADD_MEMBER: c_ulong = 0x0004;
pub const GROUP_REMOVE_MEMBER: c_ulong = 0x0008;
pub const GROUP_LIST_MEMBERS: c_ulong = 0x0010;
pub const GROUP_ALL_ACCESS: c_ulong = STANDARD_RIGHTS_REQUIRED
    | GROUP_LIST_MEMBERS
    | GROUP_WRITE_ACCOUNT
    | GROUP_ADD_MEMBER
    | GROUP_REMOVE_MEMBER
    | GROUP_READ_INFORMATION;
pub const GROUP_READ: c_ulong = STANDARD_RIGHTS_READ | GROUP_LIST_MEMBERS;
pub const GROUP_WRITE: c_ulong = STANDARD_RIGHTS_WRITE
    | GROUP_WRITE_ACCOUNT
    | GROUP_ADD_MEMBER
    | GROUP_REMOVE_MEMBER;
pub const GROUP_EXECUTE: c_ulong =
    STANDARD_RIGHTS_EXECUTE | GROUP_READ_INFORMATION;
...
EXTERN! {extern "system" {
    ...
    fn SamGetMembersInGroup(
        GroupHandle: SAM_HANDLE,
        MemberIds: *mut *mut c_ulong,
        Attributes: *mut *mut c_ulong,
        MemberCount: *mut c_ulong,
    ) -> NTSTATUS;
...
pub const ALIAS_ADD_MEMBER: c_ulong = 0x0001;
pub const ALIAS_REMOVE_MEMBER: c_ulong = 0x0002;
pub const ALIAS_LIST_MEMBERS: c_ulong = 0x0004;
pub const ALIAS_READ_INFORMATION: c_ulong = 0x0008;
pub const ALIAS_WRITE_ACCOUNT: c_ulong = 0x0010;
pub const ALIAS_ALL_ACCESS: c_ulong = STANDARD_RIGHTS_REQUIRED
    | ALIAS_READ_INFORMATION
    | ALIAS_WRITE_ACCOUNT
    | ALIAS_LIST_MEMBERS
    | ALIAS_ADD_MEMBER
    | ALIAS_REMOVE_MEMBER;
pub const ALIAS_READ: c_ulong = STANDARD_RIGHTS_READ | ALIAS_LIST_MEMBERS;
pub const ALIAS_WRITE: c_ulong = STANDARD_RIGHTS_WRITE
    | ALIAS_WRITE_ACCOUNT
    | ALIAS_ADD_MEMBER
    | ALIAS_REMOVE_MEMBER;
pub const ALIAS_EXECUTE: c_ulong =
    STANDARD_RIGHTS_EXECUTE | ALIAS_READ_INFORMATION;
...
pub const ALIAS_ALL_NAME: c_ulong = 0x00000001;
pub const ALIAS_ALL_MEMBER_COUNT: c_ulong = 0x00000002;
pub const ALIAS_ALL_ADMIN_COMMENT: c_ulong = 0x00000004;
pub const ALIAS_ALL_SHELL_ADMIN_OBJECT_PROPERTIES: c_ulong = 0x00000008;
...
EXTERN! {extern "system" {
    ...
    fn SamGetAliasMembership(
        ...
        PassedCount: c_ulong,
        Sids: *mut PSID,
        MembershipCount: *mut c_ulong,
        Aliases: *mut *mut c_ulong,
    ) -> NTSTATUS;
}}
...
pub const GROUP_TYPE_RESOURCE_BEHAVOIR: u32 = GROUP_TYPE_RESOURCE_GROUP
    | GROUP_TYPE_APP_BASIC_GROUP
    | GROUP_TYPE_APP_QUERY_GROUP;
pub const USER_READ_GENERAL: c_ulong = 0x0001;
pub const USER_READ_PREFERENCES: c_ulong = 0x0002;
pub const USER_WRITE_PREFERENCES: c_ulong = 0x0004;
pub const USER_READ_LOGON: c_ulong = 0x0008;
pub const USER_READ_ACCOUNT: c_ulong = 0x0010;
pub const USER_WRITE_ACCOUNT: c_ulong = 0x0020;
pub const USER_CHANGE_PASSWORD: c_ulong = 0x0040;
pub const USER_FORCE_PASSWORD_CHANGE: c_ulong = 0x0080;
pub const USER_LIST_GROUPS: c_ulong = 0x0100;
pub const USER_READ_GROUP_INFORMATION: c_ulong = 0x0200;
pub const USER_WRITE_GROUP_INFORMATION: c_ulong = 0x0400;
pub const USER_ALL_ACCESS: c_ulong = STANDARD_RIGHTS_REQUIRED
...
pub const USER_READ: c_ulong = STANDARD_RIGHTS_READ
    | USER_READ_PREFERENCES
    | USER_READ_LOGON
    | USER_READ_ACCOUNT
    | USER_LIST_GROUPS
    | USER_READ_GROUP_INFORMATION;
pub const USER_WRITE: c_ulong =
    STANDARD_RIGHTS_WRITE | USER_WRITE_PREFERENCES | USER_CHANGE_PASSWORD;
pub const USER_EXECUTE: c_ulong =
    STANDARD_RIGHTS_EXECUTE | USER_READ_GENERAL | USER_CHANGE_PASSWORD;
...
pub const USER_ALL_USERNAME: c_ulong = 0x00000001;
pub const USER_ALL_FULLNAME: c_ulong = 0x00000002;
pub const USER_ALL_USERID: c_ulong = 0x00000004;
pub const USER_ALL_PRIMARYGROUPID: c_ulong = 0x00000008;
pub const USER_ALL_ADMINCOMMENT: c_ulong = 0x00000010;
pub const USER_ALL_USERCOMMENT: c_ulong = 0x00000020;
pub const USER_ALL_HOMEDIRECTORY: c_ulong = 0x00000040;
pub const USER_ALL_HOMEDIRECTORYDRIVE: c_ulong = 0x00000080;
pub const USER_ALL_SCRIPTPATH: c_ulong = 0x00000100;
pub const USER_ALL_PROFILEPATH: c_ulong = 0x00000200;
pub const USER_ALL_WORKSTATIONS: c_ulong = 0x00000400;
pub const USER_ALL_LASTLOGON: c_ulong = 0x00000800;
pub const USER_ALL_LASTLOGOFF: c_ulong = 0x00001000;
pub const USER_ALL_LOGONHOURS: c_ulong = 0x00002000;
pub const USER_ALL_BADPASSWORDCOUNT: c_ulong = 0x00004000;
pub const USER_ALL_LOGONCOUNT: c_ulong = 0x00008000;
pub const USER_ALL_PASSWORDCANCHANGE: c_ulong = 0x00010000;
pub const USER_ALL_PASSWORDMUSTCHANGE: c_ulong = 0x00020000;
pub const USER_ALL_PASSWORDLASTSET: c_ulong = 0x00040000;
pub const USER_ALL_ACCOUNTEXPIRES: c_ulong = 0x00080000;
pub const USER_ALL_USERACCOUNTCONTROL: c_ulong = 0x00100000;
pub const USER_ALL_PARAMETERS: c_ulong = 0x00200000;
pub const USER_ALL_COUNTRYCODE: c_ulong = 0x00400000;
pub const USER_ALL_CODEPAGE: c_ulong = 0x00800000;
pub const USER_ALL_NTPASSWORDPRESENT: c_ulong = 0x01000000;
pub const USER_ALL_LMPASSWORDPRESENT: c_ulong = 0x02000000;
pub const USER_ALL_PRIVATEDATA: c_ulong = 0x04000000;
pub const USER_ALL_PASSWORDEXPIRED: c_ulong = 0x08000000;
pub const USER_ALL_SECURITYDESCRIPTOR: c_ulong = 0x10000000;
pub const USER_ALL_OWFPASSWORD: c_ulong = 0x20000000;
pub const USER_ALL_UNDEFINED_MASK: c_ulong = 0xc0000000;
pub const USER_ALL_READ_GENERAL_MASK: c_ulong = USER_ALL_USERNAME
    | USER_ALL_FULLNAME
    | USER_ALL_USERID
    | USER_ALL_PRIMARYGROUPID
    | USER_ALL_ADMINCOMMENT
    | USER_ALL_USERCOMMENT;
pub const USER_ALL_READ_LOGON_MASK: c_ulong = USER_ALL_HOMEDIRECTORY
...
pub const USER_ALL_READ_ACCOUNT_MASK: c_ulong = USER_ALL_PASSWORDLASTSET
    | USER_ALL_ACCOUNTEXPIRES
    | USER_ALL_USERACCOUNTCONTROL
    | USER_ALL_PARAMETERS;
pub const USER_ALL_READ_PREFERENCES_MASK: c_ulong =
    USER_ALL_COUNTRYCODE | USER_ALL_CODEPAGE;
pub const USER_ALL_READ_TRUSTED_MASK: c_ulong = USER_ALL_NTPASSWORDPRESENT
    | USER_ALL_LMPASSWORDPRESENT
    | USER_ALL_PASSWORDEXPIRED
    | USER_ALL_SECURITYDESCRIPTOR
    | USER_ALL_PRIVATEDATA;
pub const USER_ALL_READ_CANT_MASK: c_ulong = USER_ALL_UNDEFINED_MASK;
pub const USER_ALL_WRITE_ACCOUNT_MASK: c_ulong = USER_ALL_USERNAME
    | USER_ALL_FULLNAME
    | USER_ALL_PRIMARYGROUPID
    ...
    | USER_ALL_USERACCOUNTCONTROL
    | USER_ALL_PARAMETERS;
pub const USER_ALL_WRITE_PREFERENCES_MASK: c_ulong =
    USER_ALL_USERCOMMENT | USER_ALL_COUNTRYCODE | USER_ALL_CODEPAGE;
pub const USER_ALL_WRITE_FORCE_PASSWORD_CHANGE_MASK: c_ulong =
    USER_ALL_NTPASSWORDPRESENT
        | USER_ALL_LMPASSWORDPRESENT
        | USER_ALL_PASSWORDEXPIRED;
pub const USER_ALL_WRITE_TRUSTED_MASK: c_ulong = USER_ALL_LASTLOGON
    | USER_ALL_LASTLOGOFF
    | USER_ALL_BADPASSWORDCOUNT
    | USER_ALL_LOGONCOUNT
    ...
    | USER_ALL_SECURITYDESCRIPTOR
    | USER_ALL_PRIVATEDATA;
pub const USER_ALL_WRITE_CANT_MASK: c_ulong = USER_ALL_USERID
    | USER_ALL_PASSWORDCANCHANGE
    | USER_ALL_PASSWORDMUSTCHANGE
...
STRUCT! {#[repr(packed(4))] struct USER_LOGON_INFORMATION {
    ...
    BadPasswordCount: c_ushort,
    LogonCount: c_ushort,
    UserAccountControl: c_ulong,
}}
...
pub const USER_EXTENDED_FIELD_USER_TILE: c_ulong = 0x00001000;
pub const USER_EXTENDED_FIELD_PASSWORD_HINT: c_ulong = 0x00002000;
pub const USER_EXTENDED_FIELD_DONT_SHOW_IN_LOGON_UI: c_ulong = 0x00004000;
pub const USER_EXTENDED_FIELD_SHELL_ADMIN_OBJECT_PROPERTIES: c_ulong =
    0x00008000;
STRUCT! {struct USER_EXTENDED_INFORMATION {
    ExtendedWhichFields: c_ulong,
    UserTile: SAM_USER_TILE,
    PasswordHint: UNICODE_STRING,
    DontShowInLogonUI: c_uchar,
    ShellAdminObjectProperties: SAM_SHELL_OBJECT_PROPERTIES,
}}
pub type PUSER_EXTENDED_INFORMATION = *mut USER_EXTENDED_INFORMATION;
STRUCT! {struct USER_LOGON_UI_INFORMATION {
    PasswordIsBlank: c_uchar,
    AccountIsDisabled: c_uchar,
}}
pub type PUSER_LOGON_UI_INFORMATION = *mut USER_LOGON_UI_INFORMATION;
STRUCT! {struct USER_PWD_CHANGE_FAILURE_INFORMATION {
    ExtendedFailureReason: c_ulong,
    FilterModuleName: UNICODE_STRING,
}}
pub type PUSER_PWD_CHANGE_FAILURE_INFORMATION =
    *mut USER_PWD_CHANGE_FAILURE_INFORMATION;
...
EXTERN! {extern "system" {
    ...
    fn SamQueryDisplayInformation(
        ...
        Index: c_ulong,
        EntryCount: c_ulong,
        PreferredMaximumLength: c_ulong,
        TotalAvailable: *mut c_ulong,
        TotalReturned: *mut c_ulong,
        ReturnedEntryCount: *mut c_ulong,
...
FN! {stdcall PSAM_DELTA_NOTIFICATION_ROUTINE(
    ...
    ModifiedCount: *mut LARGE_INTEGER,
...
STRUCT! {struct SAM_VALIDATE_PERSISTED_FIELDS {
    PresentFields: c_ulong,
    PasswordLastSet: LARGE_INTEGER,
    BadPasswordTime: LARGE_INTEGER,
    LockoutTime: LARGE_INTEGER,
    BadPasswordCount: c_ulong,
    PasswordHistoryLength: c_ulong,
...
pub type PSAM_VALIDATE_STANDARD_OUTPUT_ARG =
    *mut SAM_VALIDATE_STANDARD_OUTPUT_ARG;
STRUCT! {struct SAM_VALIDATE_AUTHENTICATION_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
    PasswordMatched: c_uchar,
}}
pub type PSAM_VALIDATE_AUTHENTICATION_INPUT_ARG =
    *mut SAM_VALIDATE_AUTHENTICATION_INPUT_ARG;
STRUCT! {struct SAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG {
    ...
    PasswordMatch: c_uchar,
}}
pub type PSAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG =
    *mut SAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG;
STRUCT! {struct SAM_VALIDATE_PASSWORD_RESET_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
    ClearPassword: UNICODE_STRING,
    UserAccountName: UNICODE_STRING,
    HashedPassword: SAM_VALIDATE_PASSWORD_HASH,
    PasswordMustChangeAtNextLogon: c_uchar,
    ClearLockout: c_uchar,
}}
pub type PSAM_VALIDATE_PASSWORD_RESET_INPUT_ARG =
    *mut SAM_VALIDATE_PASSWORD_RESET_INPUT_ARG;
