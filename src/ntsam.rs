...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_RID_ENUMERATION {
    RelativeId: ULONG,
    Name: UNICODE_STRING,
}}
pub type PSAM_RID_ENUMERATION = *mut SAM_RID_ENUMERATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_SID_ENUMERATION {
    Sid: PSID,
    Name: UNICODE_STRING,
}}
pub type PSAM_SID_ENUMERATION = *mut SAM_SID_ENUMERATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_BYTE_ARRAY {
    Size: ULONG,
    Data: PUCHAR,
}}
pub type PSAM_BYTE_ARRAY = *mut SAM_BYTE_ARRAY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_BYTE_ARRAY_32K {
    Size: ULONG,
    Data: PUCHAR,
}}
...
pub const SAM_SERVER_ALL_ACCESS: ACCESS_MASK = STANDARD_RIGHTS_REQUIRED
    | SAM_SERVER_CONNECT
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(packed(4))] struct DOMAIN_GENERAL_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(packed(4))] struct DOMAIN_GENERAL_INFORMATION2 {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_UAS_INFORMATION {
    UasCompatibilityRequired: BOOLEAN,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_LOGOFF_INFORMATION {
    ForceLogoff: LARGE_INTEGER,
}}
pub type PDOMAIN_LOGOFF_INFORMATION = *mut DOMAIN_LOGOFF_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_OEM_INFORMATION {
    OemInformation: UNICODE_STRING,
}}
pub type PDOMAIN_OEM_INFORMATION = *mut DOMAIN_OEM_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_NAME_INFORMATION {
    DomainName: UNICODE_STRING,
}}
pub type PDOMAIN_NAME_INFORMATION = *mut DOMAIN_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_SERVER_ROLE_INFORMATION {
    DomainServerRole: DOMAIN_SERVER_ROLE,
}}
pub type PDOMAIN_SERVER_ROLE_INFORMATION = *mut DOMAIN_SERVER_ROLE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_REPLICATION_INFORMATION {
    ReplicaSourceNodeName: UNICODE_STRING,
}}
pub type PDOMAIN_REPLICATION_INFORMATION = *mut DOMAIN_REPLICATION_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_MODIFIED_INFORMATION {
    DomainModifiedCount: LARGE_INTEGER,
    CreationTime: LARGE_INTEGER,
}}
pub type PDOMAIN_MODIFIED_INFORMATION = *mut DOMAIN_MODIFIED_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_MODIFIED_INFORMATION2 {
    DomainModifiedCount: LARGE_INTEGER,
    CreationTime: LARGE_INTEGER,
    ModifiedCountAtLastPromotion: LARGE_INTEGER,
}}
pub type PDOMAIN_MODIFIED_INFORMATION2 = *mut DOMAIN_MODIFIED_INFORMATION2;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_STATE_INFORMATION {
    DomainServerState: DOMAIN_SERVER_ENABLE_STATE,
}}
pub type PDOMAIN_STATE_INFORMATION = *mut DOMAIN_STATE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_LOCKOUT_INFORMATION {
    LockoutDuration: LARGE_INTEGER,
    LockoutObservationWindow: LARGE_INTEGER,
    LockoutThreshold: USHORT,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_DISPLAY_USER {
    Index: ULONG,
    Rid: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_DISPLAY_MACHINE {
    Index: ULONG,
    Rid: ULONG,
    AccountControl: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_DISPLAY_GROUP {
    Index: ULONG,
    Rid: ULONG,
    Attributes: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_DISPLAY_OEM_USER {
    Index: ULONG,
    User: OEM_STRING,
}}
pub type PDOMAIN_DISPLAY_OEM_USER = *mut DOMAIN_DISPLAY_OEM_USER;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_DISPLAY_OEM_GROUP {
    Index: ULONG,
    Group: OEM_STRING,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_LOCALIZABLE_ACCOUNT_ENTRY {
    Rid: ULONG,
    Use: SID_NAME_USE,
    Name: UNICODE_STRING,
    AdminComment: UNICODE_STRING,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct DOMAIN_LOCALIZABLE_ACCOUNTS_BASIC {
    Count: ULONG,
...
pub const GROUP_ALL_ACCESS: ACCESS_MASK = STANDARD_RIGHTS_REQUIRED
    | GROUP_LIST_MEMBERS
    | GROUP_WRITE_ACCOUNT
    | GROUP_ADD_MEMBER
    | GROUP_REMOVE_MEMBER
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GROUP_MEMBERSHIP {
    RelativeId: ULONG,
    Attributes: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GROUP_GENERAL_INFORMATION {
    Name: UNICODE_STRING,
    Attributes: ULONG,
    MemberCount: ULONG,
    AdminComment: UNICODE_STRING,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GROUP_NAME_INFORMATION {
    Name: UNICODE_STRING,
}}
pub type PGROUP_NAME_INFORMATION = *mut GROUP_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GROUP_ATTRIBUTE_INFORMATION {
    Attributes: ULONG,
}}
pub type PGROUP_ATTRIBUTE_INFORMATION = *mut GROUP_ATTRIBUTE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GROUP_ADM_COMMENT_INFORMATION {
    AdminComment: UNICODE_STRING,
}}
...
pub const ALIAS_ALL_ACCESS: ACCESS_MASK = STANDARD_RIGHTS_REQUIRED
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALIAS_GENERAL_INFORMATION {
    Name: UNICODE_STRING,
    MemberCount: ULONG,
    AdminComment: UNICODE_STRING,
}}
pub type PALIAS_GENERAL_INFORMATION = *mut ALIAS_GENERAL_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALIAS_NAME_INFORMATION {
    Name: UNICODE_STRING,
}}
pub type PALIAS_NAME_INFORMATION = *mut ALIAS_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALIAS_ADM_COMMENT_INFORMATION {
    AdminComment: UNICODE_STRING,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALIAS_EXTENDED_INFORMATION {
    WhichFields: ULONG,
...
pub const USER_ALL_ACCESS: DWORD = STANDARD_RIGHTS_REQUIRED
...
pub const USER_READ: DWORD = STANDARD_RIGHTS_READ
    | USER_READ_PREFERENCES
    | USER_READ_LOGON
    | USER_READ_ACCOUNT
    | USER_LIST_GROUPS
    | USER_READ_GROUP_INFORMATION;
pub const USER_WRITE: DWORD = STANDARD_RIGHTS_WRITE | USER_WRITE_PREFERENCES | USER_CHANGE_PASSWORD;
...
pub const USER_ALL_READ_GENERAL_MASK: ULONG = USER_ALL_USERNAME
    | USER_ALL_FULLNAME
    | USER_ALL_USERID
    | USER_ALL_PRIMARYGROUPID
    | USER_ALL_ADMINCOMMENT
    | USER_ALL_USERCOMMENT;
pub const USER_ALL_READ_LOGON_MASK: ULONG = USER_ALL_HOMEDIRECTORY
...
pub const USER_ALL_READ_ACCOUNT_MASK: ULONG = USER_ALL_PASSWORDLASTSET
...
pub const USER_ALL_WRITE_ACCOUNT_MASK: ULONG = USER_ALL_USERNAME
    | USER_ALL_FULLNAME
    | USER_ALL_PRIMARYGROUPID
...
pub const USER_ALL_WRITE_TRUSTED_MASK: ULONG = USER_ALL_LASTLOGON
    | USER_ALL_LASTLOGOFF
    | USER_ALL_BADPASSWORDCOUNT
    | USER_ALL_LOGONCOUNT
    ...
    | USER_ALL_SECURITYDESCRIPTOR
    | USER_ALL_PRIVATEDATA;
pub const USER_ALL_WRITE_CANT_MASK: ULONG = USER_ALL_USERID
    | USER_ALL_PASSWORDCANCHANGE
    | USER_ALL_PASSWORDMUSTCHANGE
    | USER_ALL_UNDEFINED_MASK;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_GENERAL_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_PREFERENCES_INFORMATION {
    UserComment: UNICODE_STRING,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_PARAMETERS_INFORMATION {
    Parameters: UNICODE_STRING,
}}
pub type PUSER_PARAMETERS_INFORMATION = *mut USER_PARAMETERS_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(packed(4))] struct USER_LOGON_INFORMATION {
    UserName: UNICODE_STRING,
    FullName: UNICODE_STRING,
    UserId: ULONG,
    PrimaryGroupId: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(packed(4))] struct USER_ACCOUNT_INFORMATION {
    UserName: UNICODE_STRING,
    FullName: UNICODE_STRING,
    UserId: ULONG,
    PrimaryGroupId: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_ACCOUNT_NAME_INFORMATION {
    UserName: UNICODE_STRING,
}}
pub type PUSER_ACCOUNT_NAME_INFORMATION = *mut USER_ACCOUNT_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_FULL_NAME_INFORMATION {
    FullName: UNICODE_STRING,
}}
pub type PUSER_FULL_NAME_INFORMATION = *mut USER_FULL_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_NAME_INFORMATION {
    UserName: UNICODE_STRING,
    FullName: UNICODE_STRING,
}}
pub type PUSER_NAME_INFORMATION = *mut USER_NAME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_PRIMARY_GROUP_INFORMATION {
    PrimaryGroupId: ULONG,
}}
pub type PUSER_PRIMARY_GROUP_INFORMATION = *mut USER_PRIMARY_GROUP_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_HOME_INFORMATION {
    HomeDirectory: UNICODE_STRING,
    HomeDirectoryDrive: UNICODE_STRING,
}}
pub type PUSER_HOME_INFORMATION = *mut USER_HOME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_SCRIPT_INFORMATION {
    ScriptPath: UNICODE_STRING,
}}
pub type PUSER_SCRIPT_INFORMATION = *mut USER_SCRIPT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_PROFILE_INFORMATION {
    ProfilePath: UNICODE_STRING,
}}
pub type PUSER_PROFILE_INFORMATION = *mut USER_PROFILE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_ADMIN_COMMENT_INFORMATION {
    AdminComment: UNICODE_STRING,
}}
pub type PUSER_ADMIN_COMMENT_INFORMATION = *mut USER_ADMIN_COMMENT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_WORKSTATIONS_INFORMATION {
    WorkStations: UNICODE_STRING,
}}
pub type PUSER_WORKSTATIONS_INFORMATION = *mut USER_WORKSTATIONS_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_SET_PASSWORD_INFORMATION {
    Password: UNICODE_STRING,
    PasswordExpired: BOOLEAN,
}}
pub type PUSER_SET_PASSWORD_INFORMATION = *mut USER_SET_PASSWORD_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_CONTROL_INFORMATION {
    UserAccountControl: ULONG,
}}
pub type PUSER_CONTROL_INFORMATION = *mut USER_CONTROL_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_EXPIRES_INFORMATION {
    AccountExpires: LARGE_INTEGER,
}}
pub type PUSER_EXPIRES_INFORMATION = *mut USER_EXPIRES_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_LOGON_HOURS_INFORMATION {
    LogonHours: LOGON_HOURS,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_EXTENDED_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_LOGON_UI_INFORMATION {
    PasswordIsBlank: BOOLEAN,
    AccountIsDisabled: BOOLEAN,
}}
pub type PUSER_LOGON_UI_INFORMATION = *mut USER_LOGON_UI_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct USER_PWD_CHANGE_FAILURE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_GROUP_MEMBER_ID {
    MemberRid: ULONG,
}}
pub type PSAM_GROUP_MEMBER_ID = *mut SAM_GROUP_MEMBER_ID;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_ALIAS_MEMBER_ID {
    MemberSid: PSID,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_PASSWORD_HASH {
    Length: ULONG,
    Hash: PUCHAR,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_PERSISTED_FIELDS {
    PresentFields: ULONG,
    PasswordLastSet: LARGE_INTEGER,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_STANDARD_OUTPUT_ARG {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_AUTHENTICATION_INPUT_ARG {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_PASSWORD_CHANGE_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_VALIDATE_PASSWORD_RESET_INPUT_ARG {
    InputPersistedFields: SAM_VALIDATE_PERSISTED_FIELDS,
    ClearPassword: UNICODE_STRING,
    UserAccountName: UNICODE_STRING,
    HashedPassword: SAM_VALIDATE_PASSWORD_HASH,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_OPERATION_OBJCHG_INPUT {
    Register: BOOLEAN,
    EventHandle: ULONG64,
    ObjectType: SECURITY_DB_OBJECT_TYPE,
    ProcessID: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SAM_OPERATION_OBJCHG_OUTPUT {
    Reserved: ULONG,
}}
