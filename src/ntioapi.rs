...
STRUCT! {#[debug] struct IO_STATUS_BLOCK {
    u: IO_STATUS_BLOCK_u,
...
STRUCT! {#[debug] struct FILE_IO_COMPLETION_INFORMATION {
    KeyContext: PVOID,
    ApcContext: PVOID,
...
STRUCT! {#[debug] struct FILE_BASIC_INFORMATION {
...
STRUCT! {#[debug] struct FILE_STANDARD_INFORMATION {
...
STRUCT! {#[debug] struct FILE_STANDARD_INFORMATION_EX {
    AllocationSize: LARGE_INTEGER,
    EndOfFile: LARGE_INTEGER,
    NumberOfLinks: ULONG,
    DeletePending: BOOLEAN,
...
STRUCT! {#[debug] struct FILE_NETWORK_OPEN_INFORMATION {
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
    LastWriteTime: LARGE_INTEGER,
    ChangeTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_ATTRIBUTE_TAG_INFORMATION {
    FileAttributes: ULONG,
    ReparseTag: ULONG,
}}
pub type PFILE_ATTRIBUTE_TAG_INFORMATION = *mut FILE_ATTRIBUTE_TAG_INFORMATION;
STRUCT! {#[debug] struct FILE_ALLOCATION_INFORMATION {
    AllocationSize: LARGE_INTEGER,
}}
pub type PFILE_ALLOCATION_INFORMATION = *mut FILE_ALLOCATION_INFORMATION;
STRUCT! {#[debug] struct FILE_COMPRESSION_INFORMATION {
...
STRUCT! {#[debug] struct FILE_MOVE_CLUSTER_INFORMATION {
    ClusterCount: ULONG,
    RootDirectory: HANDLE,
    FileNameLength: ULONG,
    FileName: [WCHAR; 1],
...
STRUCT! {#[debug] struct FILE_RENAME_INFORMATION {
    ReplaceIfExists: BOOLEAN,
    RootDirectory: HANDLE,
    FileNameLength: ULONG,
    FileName: [WCHAR; 1],
...
STRUCT! {#[debug] struct FILE_STREAM_INFORMATION {
...
STRUCT! {#[debug] struct FILE_PIPE_REMOTE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_MAILSLOT_QUERY_INFORMATION {
...
STRUCT! {#[debug] struct FILE_SFIO_RESERVE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_SFIO_VOLUME_INFORMATION {
...
STRUCT! {#[debug] struct FILE_IO_COMPLETION_NOTIFICATION_INFORMATION {
    Flags: ULONG,
}}
pub type PFILE_IO_COMPLETION_NOTIFICATION_INFORMATION =
    *mut FILE_IO_COMPLETION_NOTIFICATION_INFORMATION;
STRUCT! {#[debug] struct FILE_PROCESS_IDS_USING_FILE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_IS_REMOTE_DEVICE_INFORMATION {
    IsRemote: BOOLEAN,
}}
pub type PFILE_IS_REMOTE_DEVICE_INFORMATION = *mut FILE_IS_REMOTE_DEVICE_INFORMATION;
STRUCT! {#[debug] struct FILE_NUMA_NODE_INFORMATION {
    NodeNumber: USHORT,
}}
pub type PFILE_NUMA_NODE_INFORMATION = *mut FILE_NUMA_NODE_INFORMATION;
STRUCT! {#[debug] struct FILE_IOSTATUSBLOCK_RANGE_INFORMATION {
    IoStatusBlockRange: PUCHAR,
    Length: ULONG,
}}
pub type PFILE_IOSTATUSBLOCK_RANGE_INFORMATION = *mut FILE_IOSTATUSBLOCK_RANGE_INFORMATION;
STRUCT! {#[debug] struct FILE_REMOTE_PROTOCOL_INFORMATION_GenericReserved {
    Reserved: [ULONG; 8],
}}
STRUCT! {#[debug] struct FILE_REMOTE_PROTOCOL_INFORMATION_ProtocolSpecific_Smb2_Server {
    Capabilities: ULONG,
}}
STRUCT! {#[debug] struct FILE_REMOTE_PROTOCOL_INFORMATION_ProtocolSpecific_Smb2_Share {
    Capabilities: ULONG,
    CachingFlags: ULONG,
}}
STRUCT! {#[debug] struct FILE_REMOTE_PROTOCOL_INFORMATION_ProtocolSpecific_Smb2 {
...
STRUCT! {#[debug] struct FILE_REMOTE_PROTOCOL_INFORMATION {
...
STRUCT! {#[debug] struct FILE_INTEGRITY_STREAM_INFORMATION {
...
STRUCT! {#[debug] struct FILE_LINK_ENTRY_FULL_ID_INFORMATION {
    NextEntryOffset: ULONG,
...
STRUCT! {#[debug] struct FILE_ID_EXTD_BOTH_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_STAT_INFORMATION {
...
STRUCT! {#[debug] struct FILE_MEMORY_PARTITION_INFORMATION_Flags_s {
...
STRUCT! {#[debug] struct FILE_MEMORY_PARTITION_INFORMATION {
...
STRUCT! {#[debug] struct FILE_STAT_LX_INFORMATION {
    FileId: LARGE_INTEGER,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
    LastWriteTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_CASE_SENSITIVE_INFORMATION {
    Flags: ULONG,
}}
pub type PFILE_CASE_SENSITIVE_INFORMATION = *mut FILE_CASE_SENSITIVE_INFORMATION;
STRUCT! {#[debug] struct FILE_DIRECTORY_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_FULL_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_ID_FULL_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_BOTH_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_ID_BOTH_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_NAMES_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    FileNameLength: ULONG,
    FileName: [WCHAR; 1],
...
STRUCT! {#[debug] struct FILE_ID_GLOBAL_TX_DIR_INFORMATION {
    NextEntryOffset: ULONG,
    FileIndex: ULONG,
    CreationTime: LARGE_INTEGER,
    LastAccessTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_OBJECTID_INFORMATION_u_s {
...
STRUCT! {#[debug] struct FILE_GET_EA_INFORMATION {
    NextEntryOffset: ULONG,
    EaNameLength: UCHAR,
    EaName: [CHAR; 1],
}}
pub type PFILE_GET_EA_INFORMATION = *mut FILE_GET_EA_INFORMATION;
STRUCT! {#[debug] struct FILE_GET_QUOTA_INFORMATION {
    NextEntryOffset: ULONG,
    SidLength: ULONG,
    Sid: SID,
}}
pub type PFILE_GET_QUOTA_INFORMATION = *mut FILE_GET_QUOTA_INFORMATION;
STRUCT! {#[debug] struct FILE_QUOTA_INFORMATION {
    NextEntryOffset: ULONG,
    SidLength: ULONG,
    ChangeTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_FS_LABEL_INFORMATION {
    VolumeLabelLength: ULONG,
    VolumeLabel: [WCHAR; 1],
}}
pub type PFILE_FS_LABEL_INFORMATION = *mut FILE_FS_LABEL_INFORMATION;
STRUCT! {#[debug] struct FILE_FS_VOLUME_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_SIZE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_CONTROL_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_FULL_SIZE_INFORMATION {
    TotalAllocationUnits: LARGE_INTEGER,
...
STRUCT! {#[debug] struct FILE_FS_OBJECTID_INFORMATION {
    ObjectId: [UCHAR; 16],
    ExtendedInfo: [UCHAR; 48],
}}
pub type PFILE_FS_OBJECTID_INFORMATION = *mut FILE_FS_OBJECTID_INFORMATION;
STRUCT! {#[debug] struct FILE_FS_DEVICE_INFORMATION {
    DeviceType: DWORD,
    Characteristics: ULONG,
}}
pub type PFILE_FS_DEVICE_INFORMATION = *mut FILE_FS_DEVICE_INFORMATION;
STRUCT! {#[debug] struct FILE_FS_ATTRIBUTE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_SECTOR_SIZE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_DATA_COPY_INFORMATION {
    NumberOfCopies: ULONG,
}}
pub type PFILE_FS_DATA_COPY_INFORMATION = *mut FILE_FS_DATA_COPY_INFORMATION;
STRUCT! {#[debug] struct FILE_FS_METADATA_SIZE_INFORMATION {
...
STRUCT! {#[debug] struct FILE_FS_FULL_SIZE_INFORMATION_EX {
...
STRUCT! {#[debug] struct IO_COMPLETION_BASIC_INFORMATION {
    Depth: LONG,
}}
...
STRUCT! {#[debug] struct REPARSE_DATA_BUFFER_u_SymbolicLinkReparseBuffer {
...
STRUCT! {#[debug] struct REPARSE_DATA_BUFFER_u_MountPointReparseBuffer {
    SubstituteNameOffset: USHORT,
    SubstituteNameLength: USHORT,
    PrintNameOffset: USHORT,
    PrintNameLength: USHORT,
...
STRUCT! {#[debug] struct REPARSE_DATA_BUFFER_u_GenericReparseBuffer {
    DataBuffer: [UCHAR; 1],
}}
...
STRUCT! {#[debug] struct REPARSE_DATA_BUFFER {
    ReparseTag: ULONG,
...
STRUCT! {#[debug] struct FILE_PIPE_ASSIGN_EVENT_BUFFER {
    EventHandle: HANDLE,
    KeyValue: ULONG,
}}
pub type PFILE_PIPE_ASSIGN_EVENT_BUFFER = *mut FILE_PIPE_ASSIGN_EVENT_BUFFER;
STRUCT! {#[debug] struct FILE_PIPE_PEEK_BUFFER {
    NamedPipeState: ULONG,
    ReadDataAvailable: ULONG,
...
STRUCT! {#[debug] struct FILE_PIPE_EVENT_BUFFER {
    NamedPipeState: ULONG,
    EntryType: ULONG,
    ByteCount: ULONG,
    KeyValue: ULONG,
...
STRUCT! {#[debug] struct FILE_PIPE_WAIT_FOR_BUFFER {
...
STRUCT! {#[debug] struct FILE_PIPE_CLIENT_PROCESS_BUFFER {
    ClientSession: PVOID,
    ClientProcess: PVOID,
}}
...
STRUCT! {#[debug] struct FILE_PIPE_CLIENT_PROCESS_BUFFER_EX {
    ClientSession: PVOID,
    ClientProcess: PVOID,
...
STRUCT! {#[debug] struct FILE_MAILSLOT_PEEK_BUFFER {
    ReadDataAvailable: ULONG,
    NumberOfMessages: ULONG,
    MessageLength: ULONG,
}}
