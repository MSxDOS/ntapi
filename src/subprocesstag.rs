...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_FROM_TAG_IN_PARAMS {
    dwPid: DWORD,
    dwTag: DWORD,
}}
pub type PTAG_INFO_NAME_FROM_TAG_IN_PARAMS = *mut TAG_INFO_NAME_FROM_TAG_IN_PARAMS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_FROM_TAG_OUT_PARAMS {
    eTagType: DWORD,
    pszName: LPWSTR,
}}
pub type PTAG_INFO_NAME_FROM_TAG_OUT_PARAMS = *mut TAG_INFO_NAME_FROM_TAG_OUT_PARAMS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_FROM_TAG {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAMES_REFERENCING_MODULE_IN_PARAMS {
    dwPid: DWORD,
    pszModule: LPWSTR,
}}
pub type PTAG_INFO_NAMES_REFERENCING_MODULE_IN_PARAMS =
    *mut TAG_INFO_NAMES_REFERENCING_MODULE_IN_PARAMS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAMES_REFERENCING_MODULE_OUT_PARAMS {
    eTagType: DWORD,
    pmszNames: LPWSTR,
}}
pub type PTAG_INFO_NAMES_REFERENCING_MODULE_OUT_PARAMS =
    *mut TAG_INFO_NAMES_REFERENCING_MODULE_OUT_PARAMS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAMES_REFERENCING_MODULE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_TAG_MAPPING_IN_PARAMS {
    dwPid: DWORD,
}}
pub type PTAG_INFO_NAME_TAG_MAPPING_IN_PARAMS = *mut TAG_INFO_NAME_TAG_MAPPING_IN_PARAMS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_TAG_MAPPING_ELEMENT {
    eTagType: DWORD,
    dwTag: DWORD,
    pszName: LPWSTR,
    pszGroupName: LPWSTR,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_TAG_MAPPING_OUT_PARAMS {
    cElements: DWORD,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TAG_INFO_NAME_TAG_MAPPING {
