...
use ntapi_base::PCLIENT_ID;
use ntdbg::DEBUGOBJECTINFOCLASS;
use ntexapi::{
    PT2_CANCEL_PARAMETERS, PT2_SET_PARAMETERS, ATOM_INFORMATION_CLASS, EVENT_INFORMATION_CLASS,
    MUTANT_INFORMATION_CLASS, PBOOT_ENTRY, PBOOT_OPTIONS, PCWNF_TYPE_ID, PEFI_DRIVER_ENTRY,
    PFILE_PATH, PTIMER_APC_ROUTINE, PWNF_CHANGE_STAMP, PWNF_DELIVERY_DESCRIPTOR,
...
use ntobapi::OBJECT_INFORMATION_CLASS;
use ntpnpapi::{PLUGPLAY_CONTROL_CLASS, PPLUGPLAY_EVENT_BLOCK};
use ntpsapi::{
...
use ntseapi::PTOKEN_SECURITY_ATTRIBUTES_INFORMATION;
use ntapi_base::{PRTL_ATOM, RTL_ATOM};
use winapi::shared::basetsd::{
    PULONG64, ULONG64, KAFFINITY, PSIZE_T, PULONG_PTR, SIZE_T, ULONG_PTR,
};
