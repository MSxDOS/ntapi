...
STRUCT! {#[debug] struct BOOT_ENTRY {
    Version: ULONG,
    Length: ULONG,
    Id: ULONG,
    Attributes: ULONG,
...
STRUCT! {#[debug] struct EFI_DRIVER_ENTRY {
    Version: ULONG,
    Length: ULONG,
    Id: ULONG,
    FriendlyNameOffset: ULONG,
...
STRUCT! {#[debug] struct EFI_DRIVER_ENTRY_LIST {
    NextEntryOffset: ULONG,
...
STRUCT! {#[debug] struct EVENT_BASIC_INFORMATION {
...
STRUCT! {#[debug] struct SEMAPHORE_BASIC_INFORMATION {
    CurrentCount: LONG,
    MaximumCount: LONG,
}}
...
STRUCT! {#[debug] struct TIMER_BASIC_INFORMATION {
...
STRUCT! {#[debug] struct TIMER_SET_COALESCABLE_TIMER_INFO {
...
STRUCT! {#[debug] struct T2_SET_PARAMETERS {
    Version: ULONG,
    Reserved: ULONG,
...
STRUCT! {#[debug] struct WNF_TYPE_ID {
    TypeId: GUID,
}}
...
STRUCT! {#[debug] struct WNF_DELIVERY_DESCRIPTOR {
...
STRUCT! {#[debug] struct WORKER_FACTORY_BASIC_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_BASIC_INFORMATION {
    Reserved: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_PERFORMANCE_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_TIMEOFDAY_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_THREAD_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_EXTENDED_THREAD_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_PROCESS_INFORMATION {
    NextEntryOffset: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_CALL_COUNT_INFORMATION {
    Length: ULONG,
    NumberOfTables: ULONG,
}}
pub type PSYSTEM_CALL_COUNT_INFORMATION = *mut SYSTEM_CALL_COUNT_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_DEVICE_INFORMATION {
    NumberOfDisks: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION {
...
STRUCT! {#[debug] struct RTL_PROCESS_LOCKS {
    NumberOfLocks: ULONG,
    Locks: [RTL_PROCESS_LOCK_INFORMATION; 1],
}}
pub type PRTL_PROCESS_LOCKS = *mut RTL_PROCESS_LOCKS;
STRUCT! {#[debug] struct RTL_PROCESS_BACKTRACE_INFORMATION {
...
STRUCT! {#[debug] struct RTL_PROCESS_BACKTRACES {
...
STRUCT! {#[debug] struct SYSTEM_HANDLE_TABLE_ENTRY_INFO {
...
STRUCT! {#[debug] struct SYSTEM_OBJECT_INFORMATION {
    NextEntryOffset: ULONG,
    Object: PVOID,
...
STRUCT! {#[debug] struct SYSTEM_PAGEFILE_INFORMATION {
    NextEntryOffset: ULONG,
    TotalSize: ULONG,
    TotalInUse: ULONG,
    PeakUsage: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_FILECACHE_INFORMATION {
    CurrentSize: SIZE_T,
    PeakSize: SIZE_T,
    PageFaultCount: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_BASIC_WORKING_SET_INFORMATION {
    CurrentSize: SIZE_T,
    PeakSize: SIZE_T,
    PageFaultCount: ULONG,
}}
...
STRUCT! {#[debug] struct SYSTEM_POOLTAG {
    u: SYSTEM_POOLTAG_u,
    PagedAllocs: ULONG,
    PagedFrees: ULONG,
    PagedUsed: SIZE_T,
...
STRUCT! {#[debug] struct SYSTEM_POOLTAG_INFORMATION {
    Count: ULONG,
    TagInfo: [SYSTEM_POOLTAG; 1],
}}
pub type PSYSTEM_POOLTAG_INFORMATION = *mut SYSTEM_POOLTAG_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_INTERRUPT_INFORMATION {
    ContextSwitches: ULONG,
    DpcCount: ULONG,
    DpcRate: ULONG,
    TimeIncrement: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_DPC_BEHAVIOR_INFORMATION {
    Spare: ULONG,
    DpcQueueDepth: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_QUERY_TIME_ADJUST_INFORMATION {
    TimeAdjustment: ULONG,
    TimeIncrement: ULONG,
    Enable: BOOLEAN,
}}
pub type PSYSTEM_QUERY_TIME_ADJUST_INFORMATION = *mut SYSTEM_QUERY_TIME_ADJUST_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_QUERY_TIME_ADJUST_INFORMATION_PRECISE {
...
STRUCT! {#[debug] struct SYSTEM_SET_TIME_ADJUST_INFORMATION {
    TimeAdjustment: ULONG,
    Enable: BOOLEAN,
}}
pub type PSYSTEM_SET_TIME_ADJUST_INFORMATION = *mut SYSTEM_SET_TIME_ADJUST_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_SET_TIME_ADJUST_INFORMATION_PRECISE {
    TimeAdjustment: ULONGLONG,
    Enable: BOOLEAN,
}}
...
STRUCT! {#[debug] struct EVENT_TRACE_VERSION_INFORMATION {
...
STRUCT! {#[debug] struct EVENT_TRACE_SPINLOCK_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[debug] struct EVENT_TRACE_SYSTEM_EVENT_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    HookId: [ULONG; 1],
}}
pub type PEVENT_TRACE_SYSTEM_EVENT_INFORMATION = *mut EVENT_TRACE_SYSTEM_EVENT_INFORMATION;
STRUCT! {#[debug] struct EVENT_TRACE_EXECUTIVE_RESOURCE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[debug] struct EVENT_TRACE_SOFT_RESTART_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
...
STRUCT! {#[debug] struct EVENT_TRACE_PROFILE_ADD_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[debug] struct EVENT_TRACE_PROFILE_REMOVE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    ProfileSource: KPROFILE_SOURCE,
    CpuInfoHierarchy: [ULONG; 3],
}}
pub type PEVENT_TRACE_PROFILE_REMOVE_INFORMATION = *mut EVENT_TRACE_PROFILE_REMOVE_INFORMATION;
STRUCT! {#[debug] struct EVENT_TRACE_COVERAGE_SAMPLER_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[debug] struct SYSTEM_EXCEPTION_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_KERNEL_DEBUGGER_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_CONTEXT_SWITCH_INFORMATION {
    ContextSwitches: ULONG,
    FindAny: ULONG,
    FindLast: ULONG,
    FindIdeal: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_REGISTRY_QUOTA_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_IDLE_INFORMATION {
    IdleTime: ULONGLONG,
    C1Time: ULONGLONG,
    C2Time: ULONGLONG,
    C3Time: ULONGLONG,
...
STRUCT! {#[debug] struct SYSTEM_RANGE_START_INFORMATION {
    SystemRangeStart: PVOID,
}}
pub type PSYSTEM_RANGE_START_INFORMATION = *mut SYSTEM_RANGE_START_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_VERIFIER_INFORMATION {
    NextEntryOffset: ULONG,
    Level: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_SESSION_PROCESS_INFORMATION {
    SessionId: ULONG,
    SizeOfBuf: ULONG,
    Buffer: PVOID,
}}
pub type PSYSTEM_SESSION_PROCESS_INFORMATION = *mut SYSTEM_SESSION_PROCESS_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_POWER_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_HANDLE_TABLE_ENTRY_INFO_EX {
    Object: PVOID,
...
STRUCT! {#[debug] struct SYSTEM_HANDLE_INFORMATION_EX {
...
STRUCT! {#[debug] struct SYSTEM_POOL_ENTRY {
    Allocated: BOOLEAN,
    Spare0: BOOLEAN,
...
STRUCT! {#[debug] struct SYSTEM_POOL_INFORMATION {
    TotalSize: SIZE_T,
    FirstEntry: PVOID,
...
STRUCT! {#[debug] struct SYSTEM_SESSION_POOLTAG_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_SESSION_MAPPED_VIEW_INFORMATION {
    NextEntryOffset: SIZE_T,
    SessionId: ULONG,
    ViewFailures: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_FIRMWARE_TABLE_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_MEMORY_LIST_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_PROCESS_ID_INFORMATION {
    ProcessId: HANDLE,
    ImageName: UNICODE_STRING,
}}
pub type PSYSTEM_PROCESS_ID_INFORMATION = *mut SYSTEM_PROCESS_ID_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_BOOT_ENVIRONMENT_INFORMATION {
    BootIdentifier: GUID,
...
STRUCT! {#[debug] struct SYSTEM_IMAGE_FILE_EXECUTION_OPTIONS_INFORMATION {
    FlagsToEnable: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_VERIFIER_INFORMATION_EX {
    VerifyMode: ULONG,
    OptionChanges: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_VA_LIST_INFORMATION {
    VirtualSize: SIZE_T,
    VirtualPeak: SIZE_T,
    VirtualLimit: SIZE_T,
...
STRUCT! {#[debug] struct SYSTEM_REGISTRY_APPEND_STRING_PARAMETERS {
    KeyHandle: HANDLE,
...
STRUCT! {#[debug] struct SYSTEM_VHD_BOOT_INFORMATION {
    OsDiskIsVhd: BOOLEAN,
...
STRUCT! {#[debug] struct SYSTEM_LOW_PRIORITY_IO_INFORMATION {
...
STRUCT! {#[debug] struct TPM_BOOT_ENTROPY_NT_RESULT {
    Policy: ULONGLONG,
...
STRUCT! {#[debug] struct SYSTEM_VERIFIER_COUNTERS_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_ACPI_AUDIT_INFORMATION {
    RsdpCount: ULONG,
    Bitfields: ULONG,
}}
...
STRUCT! {#[debug] struct SYSTEM_BASIC_PERFORMANCE_INFORMATION {
...
STRUCT! {#[debug] struct QUERY_PERFORMANCE_COUNTER_FLAGS {
    ul: ULONG,
}}
...
STRUCT! {#[debug] struct SYSTEM_QUERY_PERFORMANCE_COUNTER_INFORMATION {
    Version: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_BOOT_GRAPHICS_INFORMATION {
...
STRUCT! {#[debug] struct MEMORY_SCRUB_INFORMATION {
    Handle: HANDLE,
    PagesScrubbed: ULONG,
}}
pub type PMEMORY_SCRUB_INFORMATION = *mut MEMORY_SCRUB_INFORMATION;
STRUCT! {#[debug] struct PEBS_DS_SAVE_AREA {
...
STRUCT! {#[debug] struct PROCESSOR_PROFILE_CONTROL_AREA {
    PebsDsSaveArea: PEBS_DS_SAVE_AREA,
}}
pub type PPROCESSOR_PROFILE_CONTROL_AREA = *mut PROCESSOR_PROFILE_CONTROL_AREA;
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_PROFILE_CONTROL_AREA {
...
STRUCT! {#[debug] struct MEMORY_COMBINE_INFORMATION {
    Handle: HANDLE,
...
STRUCT! {#[debug] struct MEMORY_COMBINE_INFORMATION_EX {
    Handle: HANDLE,
    PagesCombined: ULONG_PTR,
    Flags: ULONG,
}}
pub type PMEMORY_COMBINE_INFORMATION_EX = *mut MEMORY_COMBINE_INFORMATION_EX;
STRUCT! {#[debug] struct MEMORY_COMBINE_INFORMATION_EX2 {
    Handle: HANDLE,
    PagesCombined: ULONG_PTR,
    Flags: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_CONSOLE_INFORMATION {
    Bitfields: ULONG,
}}
...
STRUCT! {#[debug] struct SYSTEM_PLATFORM_BINARY_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_HYPERVISOR_PROCESSOR_COUNT_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_DEVICE_DATA_INFORMATION {
...
STRUCT! {#[debug] struct PHYSICAL_CHANNEL_RUN {
    NodeNumber: ULONG,
    ChannelNumber: ULONG,
    BasePage: ULONGLONG,
    PageCount: ULONGLONG,
...
STRUCT! {#[debug] struct SYSTEM_MEMORY_TOPOLOGY_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_MEMORY_CHANNEL_INFORMATION {
    ChannelNumber: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_BOOT_LOGO_INFORMATION {
    Flags: ULONG,
    BitmapOffset: ULONG,
}}
pub type PSYSTEM_BOOT_LOGO_INFORMATION = *mut SYSTEM_BOOT_LOGO_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION_EX {
    IdleTime: LARGE_INTEGER,
    KernelTime: LARGE_INTEGER,
    UserTime: LARGE_INTEGER,
    DpcTime: LARGE_INTEGER,
...
STRUCT! {#[debug] struct PROCESS_ENERGY_VALUES {
...
STRUCT! {#[debug] struct TIMELINE_BITMAP {
    Value: ULONGLONG,
    EndTime: ULONG,
    Bitmap: ULONG,
}}
pub type PTIMELINE_BITMAP = *mut TIMELINE_BITMAP;
STRUCT! {#[debug] struct PROCESS_ENERGY_VALUES_EXTENSION_Timelines {
...
STRUCT! {#[debug] struct PROCESS_ENERGY_VALUES_EXTENSION_Durations {
...
STRUCT! {#[debug] struct PROCESS_ENERGY_VALUES_EXTENSION {
...
STRUCT! {#[debug] struct PROCESS_EXTENDED_ENERGY_VALUES {
...
STRUCT! {#[debug] struct SYSTEM_PROCESS_INFORMATION_EXTENSION {
...
STRUCT! {#[debug] struct SYSTEM_PORTABLE_WORKSPACE_EFI_LAUNCHER_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_KERNEL_DEBUGGER_INFORMATION_EX {
...
STRUCT! {#[debug] struct SYSTEM_ELAM_CERTIFICATE_INFORMATION {
    ElamDriverFile: HANDLE,
}}
pub type PSYSTEM_ELAM_CERTIFICATE_INFORMATION = *mut SYSTEM_ELAM_CERTIFICATE_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_FEATURES_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION {
    Cycles: [[ULONGLONG; 4]; 2],
}}
pub type PSYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION = *mut SYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_TPM_INFORMATION {
    Flags: ULONG,
}}
pub type PSYSTEM_TPM_INFORMATION = *mut SYSTEM_TPM_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_VSM_PROTECTION_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_CODEINTEGRITYPOLICY_INFORMATION {
    Options: ULONG,
    HVCIOptions: ULONG,
    Version: ULONGLONG,
    PolicyGuid: GUID,
...
STRUCT! {#[debug] struct SYSTEM_ISOLATED_USER_MODE_INFORMATION {
    Bitfields1: BOOLEAN,
    Bitfields2: BOOLEAN,
    Spare0: [BOOLEAN; 6],
    Spare1: ULONGLONG,
...
STRUCT! {#[debug] struct SYSTEM_SINGLE_MODULE_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_INTERRUPT_CPU_SET_INFORMATION {
    Gsiv: ULONG,
    Group: USHORT,
    CpuSets: ULONGLONG,
}}
pub type PSYSTEM_INTERRUPT_CPU_SET_INFORMATION = *mut SYSTEM_INTERRUPT_CPU_SET_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_SECUREBOOT_POLICY_FULL_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_ROOT_SILO_INFORMATION {
    NumberOfSilos: ULONG,
    SiloIdList: [ULONG; 1],
}}
pub type PSYSTEM_ROOT_SILO_INFORMATION = *mut SYSTEM_ROOT_SILO_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_CPU_SET_TAG_INFORMATION {
    Tag: ULONGLONG,
    CpuSets: [ULONGLONG; 1],
}}
pub type PSYSTEM_CPU_SET_TAG_INFORMATION = *mut SYSTEM_CPU_SET_TAG_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_SECURE_KERNEL_HYPERGUARD_PROFILE_INFORMATION {
    ExtentCount: ULONG,
...
STRUCT! {#[debug] struct SYSTEM_SECUREBOOT_PLATFORM_MANIFEST_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_MEMORY_USAGE_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION {
    ImageFile: HANDLE,
    Type: ULONG,
}}
pub type PSYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION =
    *mut SYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_PHYSICAL_MEMORY_INFORMATION {
    TotalPhysicalBytes: ULONGLONG,
...
STRUCT! {#[debug] struct SYSTEM_ACTIVITY_MODERATION_INFO {
...
STRUCT! {#[debug] struct SYSTEM_ACTIVITY_MODERATION_USER_SETTINGS {
    UserKeyHandle: HANDLE,
}}
pub type PSYSTEM_ACTIVITY_MODERATION_USER_SETTINGS = *mut SYSTEM_ACTIVITY_MODERATION_USER_SETTINGS;
STRUCT! {#[debug] struct SYSTEM_CODEINTEGRITY_UNLOCK_INFORMATION {
    Flags: ULONG,
    UnlockId: [UCHAR; 32],
}}
...
STRUCT! {#[debug] struct SYSTEM_FLUSH_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_CODEINTEGRITYVERIFICATION_INFORMATION {
    FileHandle: HANDLE,
    ImageSize: ULONG,
    Image: PVOID,
}}
...
STRUCT! {#[debug] struct SYSTEM_HYPERVISOR_SHARED_PAGE_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_SPECULATION_CONTROL_INFORMATION {
    Flags: ULONG,
}}
...
STRUCT! {#[debug] struct SYSTEM_DMA_GUARD_POLICY_INFORMATION {
    DmaGuardPolicyEnabled: BOOLEAN,
}}
pub type PSYSTEM_DMA_GUARD_POLICY_INFORMATION = *mut SYSTEM_DMA_GUARD_POLICY_INFORMATION;
STRUCT! {#[debug] struct SYSTEM_ENCLAVE_LAUNCH_CONTROL_INFORMATION {
...
STRUCT! {#[debug] struct SYSTEM_WORKLOAD_ALLOWED_CPU_SET_INFORMATION {
...
STRUCT! {#[debug] struct SYSDBG_VIRTUAL {
    Address: PVOID,
    Buffer: PVOID,
    Request: ULONG,
}}
pub type PSYSDBG_VIRTUAL = *mut SYSDBG_VIRTUAL;
STRUCT! {#[debug] struct SYSDBG_PHYSICAL {
    Address: PHYSICAL_ADDRESS,
    Buffer: PVOID,
    Request: ULONG,
}}
pub type PSYSDBG_PHYSICAL = *mut SYSDBG_PHYSICAL;
STRUCT! {#[debug] struct SYSDBG_CONTROL_SPACE {
    Address: ULONG64,
    Buffer: PVOID,
    Request: ULONG,
    Processor: ULONG,
...
STRUCT! {#[debug] struct SYSDBG_IO_SPACE {
    Address: ULONG64,
    Buffer: PVOID,
    Request: ULONG,
...
STRUCT! {#[debug] struct SYSDBG_MSR {
    Msr: ULONG,
    Data: ULONG64,
}}
pub type PSYSDBG_MSR = *mut SYSDBG_MSR;
STRUCT! {#[debug] struct SYSDBG_BUS_DATA {
    Address: ULONG,
    Buffer: PVOID,
    Request: ULONG,
...
STRUCT! {#[debug] struct SYSDBG_TRIAGE_DUMP {
    Flags: ULONG,
    BugCheckCode: ULONG,
...
STRUCT! {#[debug] struct SYSDBG_LIVEDUMP_CONTROL_FLAGS {
    AsUlong: ULONG,
}}
...
STRUCT! {#[debug] struct SYSDBG_LIVEDUMP_CONTROL_ADDPAGES {
    AsUlong: ULONG,
}}
...
STRUCT! {#[debug] struct SYSDBG_LIVEDUMP_CONTROL {
    Version: ULONG,
    BugCheckCode: ULONG,
    BugCheckParam1: ULONG_PTR,
    BugCheckParam2: ULONG_PTR,
...
STRUCT! {#[debug] #[repr(packed(4))] struct KUSER_SHARED_DATA {
...
STRUCT! {#[debug] struct ATOM_BASIC_INFORMATION {
    UsageCount: USHORT,
    Flags: USHORT,
    NameLength: USHORT,
    Name: [WCHAR; 1],
...
STRUCT! {#[debug] struct ATOM_TABLE_INFORMATION {
    NumberOfAtoms: ULONG,
    Atoms: [RTL_ATOM; 1],
}}
