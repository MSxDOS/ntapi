...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct BOOT_ENTRY {
    Version: ULONG,
    Length: ULONG,
    Id: ULONG,
    Attributes: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct BOOT_ENTRY_LIST {
    NextEntryOffset: ULONG,
    BootEntry: BOOT_ENTRY,
}}
pub type PBOOT_ENTRY_LIST = *mut BOOT_ENTRY_LIST;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct BOOT_OPTIONS {
    Version: ULONG,
    Length: ULONG,
    Timeout: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct FILE_PATH {
    Version: ULONG,
    Length: ULONG,
    Type: ULONG,
    FilePath: [UCHAR; 1],
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EFI_DRIVER_ENTRY {
    Version: ULONG,
    Length: ULONG,
    Id: ULONG,
    FriendlyNameOffset: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EFI_DRIVER_ENTRY_LIST {
    NextEntryOffset: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_BASIC_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MUTANT_BASIC_INFORMATION {
    CurrentCount: LONG,
    OwnedByCaller: BOOLEAN,
    AbandonedState: BOOLEAN,
}}
pub type PMUTANT_BASIC_INFORMATION = *mut MUTANT_BASIC_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MUTANT_OWNER_INFORMATION {
    ClientId: CLIENT_ID,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SEMAPHORE_BASIC_INFORMATION {
    CurrentCount: LONG,
    MaximumCount: LONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TIMER_BASIC_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TIMER_SET_COALESCABLE_TIMER_INFO {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct T2_SET_PARAMETERS {
    Version: ULONG,
    Reserved: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct WNF_TYPE_ID {
    TypeId: GUID,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct WNF_DELIVERY_DESCRIPTOR {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct WORKER_FACTORY_BASIC_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BASIC_INFORMATION {
    Reserved: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PERFORMANCE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_TIMEOFDAY_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_THREAD_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_EXTENDED_THREAD_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESS_INFORMATION {
    NextEntryOffset: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CALL_COUNT_INFORMATION {
    Length: ULONG,
    NumberOfTables: ULONG,
}}
pub type PSYSTEM_CALL_COUNT_INFORMATION = *mut SYSTEM_CALL_COUNT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_DEVICE_INFORMATION {
    NumberOfDisks: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_FLAGS_INFORMATION {
    Flags: ULONG,
}}
pub type PSYSTEM_FLAGS_INFORMATION = *mut SYSTEM_FLAGS_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CALL_TIME_INFORMATION {
    Length: ULONG,
    TotalCalls: ULONG,
    TimeOfCalls: [LARGE_INTEGER; 1],
}}
pub type PSYSTEM_CALL_TIME_INFORMATION = *mut SYSTEM_CALL_TIME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_LOCK_INFORMATION {
    Address: PVOID,
    Type: USHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_LOCKS {
    NumberOfLocks: ULONG,
    Locks: [RTL_PROCESS_LOCK_INFORMATION; 1],
}}
pub type PRTL_PROCESS_LOCKS = *mut RTL_PROCESS_LOCKS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_BACKTRACE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_BACKTRACES {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HANDLE_TABLE_ENTRY_INFO {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HANDLE_INFORMATION {
    NumberOfHandles: ULONG,
    Handles: [SYSTEM_HANDLE_TABLE_ENTRY_INFO; 1],
}}
pub type PSYSTEM_HANDLE_INFORMATION = *mut SYSTEM_HANDLE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_OBJECTTYPE_INFORMATION {
    NextEntryOffset: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_OBJECT_INFORMATION {
    NextEntryOffset: ULONG,
    Object: PVOID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PAGEFILE_INFORMATION {
    NextEntryOffset: ULONG,
    TotalSize: ULONG,
    TotalInUse: ULONG,
    PeakUsage: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_FILECACHE_INFORMATION {
    CurrentSize: SIZE_T,
    PeakSize: SIZE_T,
    PageFaultCount: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BASIC_WORKING_SET_INFORMATION {
    CurrentSize: SIZE_T,
    PeakSize: SIZE_T,
    PageFaultCount: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_POOLTAG {
    u: SYSTEM_POOLTAG_u,
    PagedAllocs: ULONG,
    PagedFrees: ULONG,
    PagedUsed: SIZE_T,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_POOLTAG_INFORMATION {
    Count: ULONG,
    TagInfo: [SYSTEM_POOLTAG; 1],
}}
pub type PSYSTEM_POOLTAG_INFORMATION = *mut SYSTEM_POOLTAG_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_INTERRUPT_INFORMATION {
    ContextSwitches: ULONG,
    DpcCount: ULONG,
    DpcRate: ULONG,
    TimeIncrement: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_DPC_BEHAVIOR_INFORMATION {
    Spare: ULONG,
    DpcQueueDepth: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_QUERY_TIME_ADJUST_INFORMATION {
    TimeAdjustment: ULONG,
    TimeIncrement: ULONG,
    Enable: BOOLEAN,
}}
pub type PSYSTEM_QUERY_TIME_ADJUST_INFORMATION = *mut SYSTEM_QUERY_TIME_ADJUST_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_QUERY_TIME_ADJUST_INFORMATION_PRECISE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SET_TIME_ADJUST_INFORMATION {
    TimeAdjustment: ULONG,
    Enable: BOOLEAN,
}}
pub type PSYSTEM_SET_TIME_ADJUST_INFORMATION = *mut SYSTEM_SET_TIME_ADJUST_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SET_TIME_ADJUST_INFORMATION_PRECISE {
    TimeAdjustment: ULONGLONG,
    Enable: BOOLEAN,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_VERSION_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PERFINFO_GROUPMASK {
    Masks: [ULONG; 8],
}}
pub type PPERFINFO_GROUPMASK = *mut PERFINFO_GROUPMASK;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_GROUPMASK_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    EventTraceGroupMasks: PERFINFO_GROUPMASK,
}}
pub type PEVENT_TRACE_GROUPMASK_INFORMATION = *mut EVENT_TRACE_GROUPMASK_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_PERFORMANCE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    LogfileBytesWritten: LARGE_INTEGER,
}}
pub type PEVENT_TRACE_PERFORMANCE_INFORMATION = *mut EVENT_TRACE_PERFORMANCE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_TIME_PROFILE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    ProfileInterval: ULONG,
}}
pub type PEVENT_TRACE_TIME_PROFILE_INFORMATION = *mut EVENT_TRACE_TIME_PROFILE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_SESSION_SECURITY_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_SPINLOCK_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_SYSTEM_EVENT_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    HookId: [ULONG; 1],
}}
pub type PEVENT_TRACE_SYSTEM_EVENT_INFORMATION = *mut EVENT_TRACE_SYSTEM_EVENT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_EXECUTIVE_RESOURCE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_HEAP_TRACING_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    ProcessId: ULONG,
}}
pub type PEVENT_TRACE_HEAP_TRACING_INFORMATION = *mut EVENT_TRACE_HEAP_TRACING_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_TAG_FILTER_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    Filter: [ULONG; 1],
}}
pub type PEVENT_TRACE_TAG_FILTER_INFORMATION = *mut EVENT_TRACE_TAG_FILTER_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_PROFILE_COUNTER_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    ProfileSource: [ULONG; 1],
}}
pub type PEVENT_TRACE_PROFILE_COUNTER_INFORMATION = *mut EVENT_TRACE_PROFILE_COUNTER_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_PROFILE_LIST_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    Spare: ULONG,
    Profile: [*mut PROFILE_SOURCE_INFO; 1],
}}
pub type PEVENT_TRACE_PROFILE_LIST_INFORMATION = *mut EVENT_TRACE_PROFILE_LIST_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_STACK_CACHING_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
    Enabled: BOOLEAN,
    Reserved: [UCHAR; 3],
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_SOFT_RESTART_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    TraceHandle: HANDLE,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_PROFILE_ADD_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_PROFILE_REMOVE_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
    ProfileSource: KPROFILE_SOURCE,
    CpuInfoHierarchy: [ULONG; 3],
}}
pub type PEVENT_TRACE_PROFILE_REMOVE_INFORMATION = *mut EVENT_TRACE_PROFILE_REMOVE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct EVENT_TRACE_COVERAGE_SAMPLER_INFORMATION {
    EventTraceInformationClass: EVENT_TRACE_INFORMATION_CLASS,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_EXCEPTION_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_KERNEL_DEBUGGER_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CONTEXT_SWITCH_INFORMATION {
    ContextSwitches: ULONG,
    FindAny: ULONG,
    FindLast: ULONG,
    FindIdeal: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_REGISTRY_QUOTA_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_IDLE_INFORMATION {
    IdleTime: ULONGLONG,
    C1Time: ULONGLONG,
    C2Time: ULONGLONG,
    C3Time: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_LEGACY_DRIVER_INFORMATION {
    VetoType: ULONG,
    VetoList: UNICODE_STRING,
}}
pub type PSYSTEM_LEGACY_DRIVER_INFORMATION = *mut SYSTEM_LEGACY_DRIVER_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_LOOKASIDE_INFORMATION {
    CurrentDepth: USHORT,
    MaximumDepth: USHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_RANGE_START_INFORMATION {
    SystemRangeStart: PVOID,
}}
pub type PSYSTEM_RANGE_START_INFORMATION = *mut SYSTEM_RANGE_START_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VERIFIER_INFORMATION {
    NextEntryOffset: ULONG,
    Level: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SESSION_PROCESS_INFORMATION {
    SessionId: ULONG,
    SizeOfBuf: ULONG,
    Buffer: PVOID,
}}
pub type PSYSTEM_SESSION_PROCESS_INFORMATION = *mut SYSTEM_SESSION_PROCESS_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_POWER_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HANDLE_TABLE_ENTRY_INFO_EX {
    Object: PVOID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HANDLE_INFORMATION_EX {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BIGPOOL_ENTRY {
    u1: SYSTEM_BIGPOOL_ENTRY_u1,
    SizeInBytes: SIZE_T,
    u2: SYSTEM_BIGPOOL_ENTRY_u2,
}}
pub type PSYSTEM_BIGPOOL_ENTRY = *mut SYSTEM_BIGPOOL_ENTRY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BIGPOOL_INFORMATION {
    Count: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_POOL_ENTRY {
    Allocated: BOOLEAN,
    Spare0: BOOLEAN,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_POOL_INFORMATION {
    TotalSize: SIZE_T,
    FirstEntry: PVOID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SESSION_POOLTAG_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SESSION_MAPPED_VIEW_INFORMATION {
    NextEntryOffset: SIZE_T,
    SessionId: ULONG,
    ViewFailures: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_FIRMWARE_TABLE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_MEMORY_LIST_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_THREAD_CID_PRIORITY_INFORMATION {
    ClientId: CLIENT_ID,
    Priority: KPRIORITY,
}}
pub type PSYSTEM_THREAD_CID_PRIORITY_INFORMATION = *mut SYSTEM_THREAD_CID_PRIORITY_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_IDLE_CYCLE_TIME_INFORMATION {
    CycleTime: ULONGLONG,
}}
pub type PSYSTEM_PROCESSOR_IDLE_CYCLE_TIME_INFORMATION =
    *mut SYSTEM_PROCESSOR_IDLE_CYCLE_TIME_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_REF_TRACE_INFORMATION {
    TraceEnable: BOOLEAN,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESS_ID_INFORMATION {
    ProcessId: HANDLE,
    ImageName: UNICODE_STRING,
}}
pub type PSYSTEM_PROCESS_ID_INFORMATION = *mut SYSTEM_PROCESS_ID_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BOOT_ENVIRONMENT_INFORMATION {
    BootIdentifier: GUID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_IMAGE_FILE_EXECUTION_OPTIONS_INFORMATION {
    FlagsToEnable: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VERIFIER_INFORMATION_EX {
    VerifyMode: ULONG,
    OptionChanges: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SYSTEM_PARTITION_INFORMATION {
    SystemPartition: UNICODE_STRING,
}}
pub type PSYSTEM_SYSTEM_PARTITION_INFORMATION = *mut SYSTEM_SYSTEM_PARTITION_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SYSTEM_DISK_INFORMATION {
    SystemDisk: UNICODE_STRING,
}}
pub type PSYSTEM_SYSTEM_DISK_INFORMATION = *mut SYSTEM_SYSTEM_DISK_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT {
    Hits: ULONGLONG,
    PercentFrequency: UCHAR,
}}
pub type PSYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT = *mut SYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT_WIN8 {
    Hits: ULONG,
    PercentFrequency: UCHAR,
}}
pub type PSYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT_WIN8 =
    *mut SYSTEM_PROCESSOR_PERFORMANCE_HITCOUNT_WIN8;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_STATE_DISTRIBUTION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_DISTRIBUTION {
    ProcessorCount: ULONG,
    Offsets: [ULONG; 1],
}}
pub type PSYSTEM_PROCESSOR_PERFORMANCE_DISTRIBUTION =
    *mut SYSTEM_PROCESSOR_PERFORMANCE_DISTRIBUTION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CODEINTEGRITY_INFORMATION {
    Length: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VA_LIST_INFORMATION {
    VirtualSize: SIZE_T,
    VirtualPeak: SIZE_T,
    VirtualLimit: SIZE_T,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_REGISTRY_APPEND_STRING_PARAMETERS {
    KeyHandle: HANDLE,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VHD_BOOT_INFORMATION {
    OsDiskIsVhd: BOOLEAN,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_LOW_PRIORITY_IO_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TPM_BOOT_ENTROPY_NT_RESULT {
    Policy: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VERIFIER_COUNTERS_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ACPI_AUDIT_INFORMATION {
    RsdpCount: ULONG,
    Bitfields: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BASIC_PERFORMANCE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct QUERY_PERFORMANCE_COUNTER_FLAGS {
    ul: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_QUERY_PERFORMANCE_COUNTER_INFORMATION {
    Version: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BOOT_GRAPHICS_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_SCRUB_INFORMATION {
    Handle: HANDLE,
    PagesScrubbed: ULONG,
}}
pub type PMEMORY_SCRUB_INFORMATION = *mut MEMORY_SCRUB_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PEBS_DS_SAVE_AREA {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESSOR_PROFILE_CONTROL_AREA {
    PebsDsSaveArea: PEBS_DS_SAVE_AREA,
}}
pub type PPROCESSOR_PROFILE_CONTROL_AREA = *mut PROCESSOR_PROFILE_CONTROL_AREA;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PROFILE_CONTROL_AREA {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_COMBINE_INFORMATION {
    Handle: HANDLE,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_COMBINE_INFORMATION_EX {
    Handle: HANDLE,
    PagesCombined: ULONG_PTR,
    Flags: ULONG,
}}
pub type PMEMORY_COMBINE_INFORMATION_EX = *mut MEMORY_COMBINE_INFORMATION_EX;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_COMBINE_INFORMATION_EX2 {
    Handle: HANDLE,
    PagesCombined: ULONG_PTR,
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CONSOLE_INFORMATION {
    Bitfields: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PLATFORM_BINARY_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HYPERVISOR_PROCESSOR_COUNT_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_DEVICE_DATA_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PHYSICAL_CHANNEL_RUN {
    NodeNumber: ULONG,
    ChannelNumber: ULONG,
    BasePage: ULONGLONG,
    PageCount: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_MEMORY_TOPOLOGY_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_MEMORY_CHANNEL_INFORMATION {
    ChannelNumber: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_BOOT_LOGO_INFORMATION {
    Flags: ULONG,
    BitmapOffset: ULONG,
}}
pub type PSYSTEM_BOOT_LOGO_INFORMATION = *mut SYSTEM_BOOT_LOGO_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION_EX {
    IdleTime: LARGE_INTEGER,
    KernelTime: LARGE_INTEGER,
    UserTime: LARGE_INTEGER,
    DpcTime: LARGE_INTEGER,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SECUREBOOT_POLICY_INFORMATION {
    PolicyPublisher: GUID,
    PolicyVersion: ULONG,
    PolicyOptions: ULONG,
}}
pub type PSYSTEM_SECUREBOOT_POLICY_INFORMATION = *mut SYSTEM_SECUREBOOT_POLICY_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PAGEFILE_INFORMATION_EX {
    Info: SYSTEM_PAGEFILE_INFORMATION,
    MinimumSize: ULONG,
    MaximumSize: ULONG,
}}
pub type PSYSTEM_PAGEFILE_INFORMATION_EX = *mut SYSTEM_PAGEFILE_INFORMATION_EX;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SECUREBOOT_INFORMATION {
    SecureBootEnabled: BOOLEAN,
    SecureBootCapable: BOOLEAN,
}}
pub type PSYSTEM_SECUREBOOT_INFORMATION = *mut SYSTEM_SECUREBOOT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_DISK_COUNTERS {
    BytesRead: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_ENERGY_VALUES {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TIMELINE_BITMAP {
    Value: ULONGLONG,
    EndTime: ULONG,
    Bitmap: ULONG,
}}
pub type PTIMELINE_BITMAP = *mut TIMELINE_BITMAP;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_ENERGY_VALUES_EXTENSION_Timelines {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_ENERGY_VALUES_EXTENSION_Durations {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_ENERGY_VALUES_EXTENSION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_EXTENDED_ENERGY_VALUES {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESS_INFORMATION_EXTENSION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PORTABLE_WORKSPACE_EFI_LAUNCHER_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_KERNEL_DEBUGGER_INFORMATION_EX {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ELAM_CERTIFICATE_INFORMATION {
    ElamDriverFile: HANDLE,
}}
pub type PSYSTEM_ELAM_CERTIFICATE_INFORMATION = *mut SYSTEM_ELAM_CERTIFICATE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_FEATURES_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_MANUFACTURING_INFORMATION {
    Options: ULONG,
    ProfileName: UNICODE_STRING,
}}
pub type PSYSTEM_MANUFACTURING_INFORMATION = *mut SYSTEM_MANUFACTURING_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ENERGY_ESTIMATION_CONFIG_INFORMATION {
    Enabled: BOOLEAN,
}}
pub type PSYSTEM_ENERGY_ESTIMATION_CONFIG_INFORMATION =
    *mut SYSTEM_ENERGY_ESTIMATION_CONFIG_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct HV_DETAILS {
    Data: [ULONG; 4],
}}
pub type PHV_DETAILS = *mut HV_DETAILS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HYPERVISOR_DETAIL_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION {
    Cycles: [[ULONGLONG; 4]; 2],
}}
pub type PSYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION = *mut SYSTEM_PROCESSOR_CYCLE_STATS_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_TPM_INFORMATION {
    Flags: ULONG,
}}
pub type PSYSTEM_TPM_INFORMATION = *mut SYSTEM_TPM_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_VSM_PROTECTION_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CODEINTEGRITYPOLICY_INFORMATION {
    Options: ULONG,
    HVCIOptions: ULONG,
    Version: ULONGLONG,
    PolicyGuid: GUID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ISOLATED_USER_MODE_INFORMATION {
    Bitfields1: BOOLEAN,
    Bitfields2: BOOLEAN,
    Spare0: [BOOLEAN; 6],
    Spare1: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SINGLE_MODULE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_INTERRUPT_CPU_SET_INFORMATION {
    Gsiv: ULONG,
    Group: USHORT,
    CpuSets: ULONGLONG,
}}
pub type PSYSTEM_INTERRUPT_CPU_SET_INFORMATION = *mut SYSTEM_INTERRUPT_CPU_SET_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SECUREBOOT_POLICY_FULL_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ROOT_SILO_INFORMATION {
    NumberOfSilos: ULONG,
    SiloIdList: [ULONG; 1],
}}
pub type PSYSTEM_ROOT_SILO_INFORMATION = *mut SYSTEM_ROOT_SILO_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CPU_SET_TAG_INFORMATION {
    Tag: ULONGLONG,
    CpuSets: [ULONGLONG; 1],
}}
pub type PSYSTEM_CPU_SET_TAG_INFORMATION = *mut SYSTEM_CPU_SET_TAG_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SECURE_KERNEL_HYPERGUARD_PROFILE_INFORMATION {
    ExtentCount: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SECUREBOOT_PLATFORM_MANIFEST_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_MEMORY_USAGE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION {
    ImageFile: HANDLE,
    Type: ULONG,
}}
pub type PSYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION =
    *mut SYSTEM_CODEINTEGRITY_CERTIFICATE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_PHYSICAL_MEMORY_INFORMATION {
    TotalPhysicalBytes: ULONGLONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ACTIVITY_MODERATION_INFO {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ACTIVITY_MODERATION_USER_SETTINGS {
    UserKeyHandle: HANDLE,
}}
pub type PSYSTEM_ACTIVITY_MODERATION_USER_SETTINGS = *mut SYSTEM_ACTIVITY_MODERATION_USER_SETTINGS;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CODEINTEGRITY_UNLOCK_INFORMATION {
    Flags: ULONG,
    UnlockId: [UCHAR; 32],
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_FLUSH_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_WRITE_CONSTRAINT_INFORMATION {
    WriteConstraintPolicy: ULONG,
    Reserved: ULONG,
}}
pub type PSYSTEM_WRITE_CONSTRAINT_INFORMATION = *mut SYSTEM_WRITE_CONSTRAINT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_KERNEL_VA_SHADOW_INFORMATION {
    Flags: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_CODEINTEGRITYVERIFICATION_INFORMATION {
    FileHandle: HANDLE,
    ImageSize: ULONG,
    Image: PVOID,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_HYPERVISOR_SHARED_PAGE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_SPECULATION_CONTROL_INFORMATION {
    Flags: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_DMA_GUARD_POLICY_INFORMATION {
    DmaGuardPolicyEnabled: BOOLEAN,
}}
pub type PSYSTEM_DMA_GUARD_POLICY_INFORMATION = *mut SYSTEM_DMA_GUARD_POLICY_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_ENCLAVE_LAUNCH_CONTROL_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSTEM_WORKLOAD_ALLOWED_CPU_SET_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_VIRTUAL {
    Address: PVOID,
    Buffer: PVOID,
    Request: ULONG,
}}
pub type PSYSDBG_VIRTUAL = *mut SYSDBG_VIRTUAL;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_PHYSICAL {
    Address: PHYSICAL_ADDRESS,
    Buffer: PVOID,
    Request: ULONG,
}}
pub type PSYSDBG_PHYSICAL = *mut SYSDBG_PHYSICAL;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_CONTROL_SPACE {
    Address: ULONG64,
    Buffer: PVOID,
    Request: ULONG,
    Processor: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_IO_SPACE {
    Address: ULONG64,
    Buffer: PVOID,
    Request: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_MSR {
    Msr: ULONG,
    Data: ULONG64,
}}
pub type PSYSDBG_MSR = *mut SYSDBG_MSR;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_BUS_DATA {
    Address: ULONG,
    Buffer: PVOID,
    Request: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_TRIAGE_DUMP {
    Flags: ULONG,
    BugCheckCode: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_LIVEDUMP_CONTROL_FLAGS {
    AsUlong: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_LIVEDUMP_CONTROL_ADDPAGES {
    AsUlong: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SYSDBG_LIVEDUMP_CONTROL {
    Version: ULONG,
    BugCheckCode: ULONG,
    BugCheckParam1: ULONG_PTR,
    BugCheckParam2: ULONG_PTR,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(packed(4))] struct KUSER_SHARED_DATA {
    ...
    #[cfg(target_arch = "x86")]
    {
        loop {
            ...
            if tick_count.s().HighPart
                == read_volatile(&(*USER_SHARED_DATA).u.TickCount.High2Time) as u32
            {
                break;
            }
            spin_loop_hint();
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ATOM_BASIC_INFORMATION {
    UsageCount: USHORT,
    Flags: USHORT,
    NameLength: USHORT,
    Name: [WCHAR; 1],
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ATOM_TABLE_INFORMATION {
    NumberOfAtoms: ULONG,
    Atoms: [RTL_ATOM; 1],
}}
