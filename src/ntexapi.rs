...
use ntapi_base::{CLIENT_ID, KPRIORITY};
...
use ntapi_base::{KSYSTEM_TIME, PRTL_ATOM, RTL_ATOM};
use winapi::shared::basetsd::{PULONG64, ULONG64, KAFFINITY, PULONG_PTR, SIZE_T, ULONG_PTR};
...
use winapi::shared::ntdef::{
    ...
    NT_PRODUCT_TYPE, NTSTATUS, PBOOLEAN, PCHAR, PCWNF_STATE_NAME, PGROUP_AFFINITY, PHANDLE,
