...
STRUCT! {#[debug] struct PF_BOOT_CONTROL {
    Version: ULONG,
...
STRUCT! {#[debug] struct PREFETCHER_INFORMATION {
    Version: ULONG,
    Magic: ULONG,
...
STRUCT! {#[debug] struct PF_SYSTEM_SUPERFETCH_PARAMETERS {
...
STRUCT! {#[debug] struct PF_PFN_PRIO_REQUEST {
    Version: ULONG,
    RequestFlags: ULONG,
    PfnCount: ULONG_PTR,
...
STRUCT! {#[debug] struct PFS_PRIVATE_PAGE_SOURCE {
...
STRUCT! {#[debug] struct PF_PRIVSOURCE_INFO {
...
STRUCT! {#[debug] struct PF_PRIVSOURCE_QUERY_REQUEST {
    Version: ULONG,
    Flags: ULONG,
    InfoCount: ULONG,
...
STRUCT! {#[debug] struct PF_SCENARIO_PHASE_INFO {
    Version: ULONG,
...
STRUCT! {#[debug] struct PF_MEMORY_LIST_NODE {
    Bitfields: ULONGLONG,
...
STRUCT! {#[debug] struct PF_MEMORY_LIST_INFO {
    Version: ULONG,
    Size: ULONG,
    NodeCount: ULONG,
...
STRUCT! {#[debug] struct PF_REPURPOSED_BY_PREFETCH_INFO {
    Version: ULONG,
...
STRUCT! {#[debug] struct SUPERFETCH_INFORMATION {
    Version: ULONG,
    Magic: ULONG,
