...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_WORKING_SET_BLOCK {
    Bitfields: ULONG_PTR,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_WORKING_SET_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_REGION_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_WORKING_SET_EX_BLOCK {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_WORKING_SET_EX_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_SHARED_COMMIT_INFORMATION {
    CommitSize: SIZE_T,
}}
pub type PMEMORY_SHARED_COMMIT_INFORMATION = *mut MEMORY_SHARED_COMMIT_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_IMAGE_INFORMATION {
    ImageBase: PVOID,
    SizeOfImage: SIZE_T,
    ImageFlags: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_ENCLAVE_IMAGE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_FRAME_INFORMATION {
    Bitfields: ULONGLONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct FILEOFFSET_INFORMATION {
    Bitfields: ULONGLONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PAGEDIR_INFORMATION {
    Bitfields: ULONGLONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct UNIQUE_PROCESS_INFORMATION {
    Bitfields: ULONGLONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MMPFN_IDENTITY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MMPFN_MEMSNAP_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SECTION_BASIC_INFORMATION {
    BaseAddress: PVOID,
    AllocationAttributes: ULONG,
    MaximumSize: LARGE_INTEGER,
}}
pub type PSECTION_BASIC_INFORMATION = *mut SECTION_BASIC_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SECTION_IMAGE_INFORMATION_u1_s {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SECTION_IMAGE_INFORMATION_u2_s {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SECTION_IMAGE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct SECTION_INTERNAL_IMAGE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_RANGE_ENTRY {
    VirtualAddress: PVOID,
    NumberOfBytes: SIZE_T,
}}
pub type PMEMORY_RANGE_ENTRY = *mut MEMORY_RANGE_ENTRY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct CFG_CALL_TARGET_LIST_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_CONFIGURATION_INFORMATION {
    Flags: ULONG,
    NumaNode: ULONG,
    Channel: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_TRANSFER_INFORMATION {
    NumberOfPages: ULONG_PTR,
    NumaNode: ULONG,
    Flags: ULONG,
}}
pub type PMEMORY_PARTITION_TRANSFER_INFORMATION = *mut MEMORY_PARTITION_TRANSFER_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_PAGEFILE_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_PAGE_COMBINE_INFORMATION {
    StopHandle: HANDLE,
    Flags: ULONG,
    TotalNumberOfPages: ULONG_PTR,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_PAGE_RANGE {
    StartPage: ULONG_PTR,
    NumberOfPages: ULONG_PTR,
}}
pub type PMEMORY_PARTITION_PAGE_RANGE = *mut MEMORY_PARTITION_PAGE_RANGE;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_INITIAL_ADD_INFORMATION {
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct MEMORY_PARTITION_MEMORY_EVENTS_INFORMATION {
    Flags: ULONG,
