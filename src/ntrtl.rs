...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_BALANCED_LINKS {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_AVL_TABLE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_SPLAY_LINKS {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_GENERIC_TABLE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_RB_TREE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DYNAMIC_HASH_TABLE_ENTRY {
    Linkage: LIST_ENTRY,
    Signature: ULONG_PTR,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DYNAMIC_HASH_TABLE_CONTEXT {
    ChainHead: PLIST_ENTRY,
    PrevLinkage: PLIST_ENTRY,
    Signature: ULONG_PTR,
}}
pub type PRTL_DYNAMIC_HASH_TABLE_CONTEXT = *mut RTL_DYNAMIC_HASH_TABLE_CONTEXT;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DYNAMIC_HASH_TABLE_ENUMERATOR {
    HashEntry: RTL_DYNAMIC_HASH_TABLE_ENTRY,
    ChainHead: PLIST_ENTRY,
    BucketIndex: ULONG,
}}
pub type PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR = *mut RTL_DYNAMIC_HASH_TABLE_ENUMERATOR;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DYNAMIC_HASH_TABLE {
    Flags: ULONG,
    Shift: ULONG,
    TableSize: ULONG,
    Pivot: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_RESOURCE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PREFIX_TABLE_ENTRY {
    NodeTypeCode: CSHORT,
    NameLength: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PREFIX_TABLE {
    NodeTypeCode: CSHORT,
    NameLength: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct UNICODE_PREFIX_TABLE_ENTRY {
    NodeTypeCode: CSHORT,
    NameLength: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct UNICODE_PREFIX_TABLE {
    NodeTypeCode: CSHORT,
    NameLength: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct COMPRESSED_DATA_INFO {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct CURDIR {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DRIVE_LETTER_CURDIR {
    Flags: USHORT,
    Length: USHORT,
    TimeStamp: ULONG,
    DosPath: STRING,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_USER_PROCESS_PARAMETERS {
    MaximumLength: ULONG,
    Length: ULONG,
    Flags: ULONG,
    DebugFlags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_USER_PROCESS_INFORMATION {
    Length: ULONG,
    Process: HANDLE,
    Thread: HANDLE,
    ClientId: CLIENT_ID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTLP_PROCESS_REFLECTION_REFLECTION_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct CONTEXT_CHUNK {
    Offset: LONG,
    Length: ULONG,
}}
pub type PCONTEXT_CHUNK = *mut CONTEXT_CHUNK;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct CONTEXT_EX {
    All: CONTEXT_CHUNK,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))] struct DYNAMIC_FUNCTION_TABLE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTLP_CURDIR_REF {
    ReferenceCount: LONG,
    DirectoryHandle: HANDLE,
}}
pub type PRTLP_CURDIR_REF = *mut RTLP_CURDIR_REF;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_RELATIVE_NAME_U {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GENERATE_NAME_CONTEXT {
    Checksum: USHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_ENTRY_u_s1 {
    Settable: SIZE_T,
    Tag: ULONG,
}}
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_ENTRY_u_s2 {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_ENTRY {
    Size: SIZE_T,
    Flags: USHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_TAG {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_INFORMATION {
    BaseAddress: PVOID,
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_HEAPS {
    NumberOfHeaps: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_PARAMETERS {
    Length: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_TAG_INFO {
    NumberOfAllocations: ULONG,
    NumberOfFrees: ULONG,
    BytesAllocated: SIZE_T,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_USAGE_ENTRY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_USAGE {
    Length: ULONG,
    BytesAllocated: SIZE_T,
    BytesCommitted: SIZE_T,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_WALK_ENTRY_u_Block {
    Settable: SIZE_T,
    TagIndex: USHORT,
    AllocatorBackTraceIndex: USHORT,
    Reserved: [ULONG; 2],
}}
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_WALK_ENTRY_u_Segment {
    CommittedSize: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HEAP_WALK_ENTRY {
    DataAddress: PVOID,
    DataSize: SIZE_T,
    OverheadBytes: UCHAR,
    SegmentIndex: UCHAR,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PROCESS_HEAP_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct HEAP_INFORMATION {
    Address: ULONG_PTR,
    Mode: ULONG,
    ReserveSize: ULONG_PTR,
    CommitSize: ULONG_PTR,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct HEAP_EXTENDED_INFORMATION {
    Process: HANDLE,
    Heap: ULONG_PTR,
    Level: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct HEAP_DEBUGGING_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_MEMORY_ZONE_SEGMENT {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_MEMORY_ZONE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_PROCESS_VERIFIER_OPTIONS {
    SizeStruct: ULONG,
    Option: ULONG,
    OptionData: [UCHAR; 1],
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_DEBUG_INFORMATION {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PARSE_MESSAGE_CONTEXT {
    fFlags: ULONG,
    cwSavColumn: ULONG,
    iwSrc: SIZE_T,
    iwDst: SIZE_T,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TIME_FIELDS {
    Year: CSHORT,
    Month: CSHORT,
    Day: CSHORT,
    Hour: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_TIME_ZONE_INFORMATION {
    Bias: LONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_BITMAP {
    SizeOfBitMap: ULONG,
    Buffer: PULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_BITMAP_RUN {
    StartingIndex: ULONG,
    NumberOfBits: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_BITMAP_EX {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_HANDLE_TABLE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_QUERY_REGISTRY_TABLE {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_ELEVATION_FLAGS {
    Flags: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_UNLOAD_EVENT_TRACE {
    BaseAddress: PVOID,
    SizeOfImage: SIZE_T,
    Sequence: ULONG,
    TimeDateStamp: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_UNLOAD_EVENT_TRACE32 {
    BaseAddress: ULONG,
    SizeOfImage: ULONG,
    Sequence: ULONG,
    TimeDateStamp: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_DEP_POLICY {
    Dep: RTL_IMAGE_MITIGATION_POLICY,
}}
pub type PRTL_IMAGE_MITIGATION_DEP_POLICY = *mut RTL_IMAGE_MITIGATION_DEP_POLICY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_ASLR_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_DYNAMIC_CODE_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_STRICT_HANDLE_CHECK_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_EXTENSION_POINT_DISABLE_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_CONTROL_FLOW_GUARD_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_BINARY_SIGNATURE_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_FONT_DISABLE_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_IMAGE_LOAD_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_PAYLOAD_RESTRICTION_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_CHILD_PROCESS_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_SEHOP_POLICY {
    Sehop: RTL_IMAGE_MITIGATION_POLICY,
}}
pub type PRTL_IMAGE_MITIGATION_SEHOP_POLICY = *mut RTL_IMAGE_MITIGATION_SEHOP_POLICY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_IMAGE_MITIGATION_HEAP_POLICY {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PS_PKG_CLAIM {
    Flags: ULONGLONG,
    Origin: ULONGLONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_BSD_ITEM {
