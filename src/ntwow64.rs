...
STRUCT! {#[debug] struct RTL_BALANCED_NODE32_u_s {
...
STRUCT! {#[debug] struct LDR_SERVICE_TAG_RECORD32 {
    Next: ULONG,
    ServiceTag: ULONG,
}}
pub type PLDR_SERVICE_TAG_RECORD32 = *mut LDR_SERVICE_TAG_RECORD32;
STRUCT! {#[debug] struct LDRP_CSLIST32 {
...
STRUCT! {#[debug] struct LDR_DDAG_NODE32 {
...
STRUCT! {#[debug] struct LDR_DATA_TABLE_ENTRY32 {
...
STRUCT! {#[debug] struct RTL_USER_PROCESS_PARAMETERS32 {
    MaximumLength: ULONG,
    Length: ULONG,
    Flags: ULONG,
    DebugFlags: ULONG,
...
pub fn UStr32ToUStr(Destination: &mut UNICODE_STRING, Source: &UNICODE_STRING32) {
...
#[cfg_attr(not(feature = "aggressive-inline"), inline)]
#[cfg_attr(feature = "aggressive-inline", inline(always))]
pub fn UStrToUStr32(Destination: &mut UNICODE_STRING32, Source: &UNICODE_STRING) {
    Destination.Length = Source.Length;
    Destination.MaximumLength = Source.MaximumLength;
