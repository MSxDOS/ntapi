...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct RTL_ACTIVATION_CONTEXT_STACK_FRAME {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ACTIVATION_CONTEXT_STACK {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct API_SET_NAMESPACE {
    Version: ULONG,
    Size: ULONG,
    Flags: ULONG,
    Count: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct API_SET_HASH_ENTRY {
    Hash: ULONG,
    Index: ULONG,
}}
pub type PAPI_SET_HASH_ENTRY = *mut API_SET_HASH_ENTRY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct API_SET_NAMESPACE_ENTRY {
    Flags: ULONG,
    NameOffset: ULONG,
    NameLength: ULONG,
    HashedLength: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct API_SET_VALUE_ENTRY {
    Flags: ULONG,
    NameOffset: ULONG,
    NameLength: ULONG,
    ValueOffset: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PEB {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct GDI_TEB_BATCH {
    Offset: ULONG,
    HDC: ULONG_PTR,
    Buffer: [ULONG; GDI_BATCH_BUFFER_SIZE],
}}
pub type PGDI_TEB_BATCH = *mut GDI_TEB_BATCH;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TEB_ACTIVE_FRAME_CONTEXT {
    Flags: ULONG,
    FrameName: PSTR,
}}
pub type PTEB_ACTIVE_FRAME_CONTEXT = *mut TEB_ACTIVE_FRAME_CONTEXT;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TEB_ACTIVE_FRAME {
    Flags: ULONG,
    Previous: *mut TEB_ACTIVE_FRAME,
    Context: PTEB_ACTIVE_FRAME_CONTEXT,
}}
pub type PTEB_ACTIVE_FRAME = *mut TEB_ACTIVE_FRAME;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TEB_u_s {
    ReservedPad0: UCHAR,
    ReservedPad1: UCHAR,
    ReservedPad2: UCHAR,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TEB {
    NtTib: NT_TIB,
