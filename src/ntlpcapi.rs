...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE_u1_s {
    DataLength: CSHORT,
    TotalLength: CSHORT,
}}
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE_u2_s {
    Type: CSHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE {
    u1: PORT_MESSAGE_u1,
    u2: PORT_MESSAGE_u2,
    u3: PORT_MESSAGE_u3,
    MessageId: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_DATA_ENTRY {
    Base: PVOID,
    Size: ULONG,
}}
pub type PPORT_DATA_ENTRY = *mut PORT_DATA_ENTRY;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_DATA_INFORMATION {
...
pub const PORT_TOTAL_MAXIMUM_MESSAGE_LENGTH: u32 = (PORT_MAXIMUM_MESSAGE_LENGTH
    ...
    + 0xf)
    & !0xf;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct LPC_CLIENT_DIED_MSG {
    PortMsg: PORT_MESSAGE,
    CreateTime: LARGE_INTEGER,
}}
pub type PLPC_CLIENT_DIED_MSG = *mut LPC_CLIENT_DIED_MSG;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_VIEW {
    Length: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct REMOTE_PORT_VIEW {
    Length: ULONG,
    ViewSize: SIZE_T,
    ViewBase: PVOID,
}}
pub type PREMOTE_PORT_VIEW = *mut REMOTE_PORT_VIEW;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE64_u1_s {
    DataLength: CSHORT,
    TotalLength: CSHORT,
}}
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE64_u2_s {
    Type: CSHORT,
    DataInfoOffset: CSHORT,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_MESSAGE64 {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct LPC_CLIENT_DIED_MSG64 {
    PortMsg: PORT_MESSAGE64,
    CreateTime: LARGE_INTEGER,
}}
pub type PLPC_CLIENT_DIED_MSG64 = *mut LPC_CLIENT_DIED_MSG64;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct PORT_VIEW64 {
    Length: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct REMOTE_PORT_VIEW64 {
    Length: ULONG,
    ViewSize: ULONGLONG,
    ViewBase: ULONGLONG,
}}
...
#[cfg(any(target_arch = "x86_64", target_arch = "aarch64"))]
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_PORT_ATTRIBUTES {
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_MESSAGE_ATTRIBUTES {
    AllocatedAttributes: ULONG,
    ValidAttributes: ULONG,
}}
pub type PALPC_MESSAGE_ATTRIBUTES = *mut ALPC_MESSAGE_ATTRIBUTES;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_COMPLETION_LIST_STATE {
    Value: ULONG64,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  #[repr(align(128))] struct ALPC_COMPLETION_LIST_HEADER {
    StartMagic: ULONG64,
    TotalSize: ULONG,
    ListOffset: ULONG,
    ListSize: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_CONTEXT_ATTR {
    PortContext: PVOID,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_HANDLE_ATTR32 {
    Flags: ULONG,
    Reserved0: ULONG,
    SameAccess: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_HANDLE_ATTR {
    Flags: ULONG,
    Reserved0: ULONG,
    SameAccess: ULONG,
    SameAttributes: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_SECURITY_ATTR {
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_DATA_VIEW_ATTR {
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_BASIC_INFORMATION {
    Flags: ULONG,
    SequenceNo: ULONG,
    PortContext: PVOID,
}}
pub type PALPC_BASIC_INFORMATION = *mut ALPC_BASIC_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_PORT_ASSOCIATE_COMPLETION_PORT {
    CompletionKey: PVOID,
    CompletionPort: HANDLE,
}}
pub type PALPC_PORT_ASSOCIATE_COMPLETION_PORT = *mut ALPC_PORT_ASSOCIATE_COMPLETION_PORT;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_SERVER_INFORMATION_Out {
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_PORT_MESSAGE_ZONE_INFORMATION {
    Buffer: PVOID,
    Size: ULONG,
}}
pub type PALPC_PORT_MESSAGE_ZONE_INFORMATION = *mut ALPC_PORT_MESSAGE_ZONE_INFORMATION;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_PORT_COMPLETION_LIST_INFORMATION {
    Buffer: PVOID,
    Size: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct ALPC_MESSAGE_HANDLE_INFORMATION {
    Index: ULONG,
    Flags: ULONG,
    Handle: ULONG,
    ObjectType: ULONG,
