...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE {
    Version: ULONG64,
    Name: UNICODE_STRING,
}}
pub type PTOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE = *mut TOKEN_SECURITY_ATTRIBUTE_FQBN_VALUE;
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TOKEN_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE {
    pValue: PVOID,
    ValueLength: ULONG,
}}
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TOKEN_SECURITY_ATTRIBUTE_V1 {
    Name: UNICODE_STRING,
    ValueType: USHORT,
    Reserved: USHORT,
    Flags: ULONG,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TOKEN_SECURITY_ATTRIBUTES_INFORMATION {
    Version: USHORT,
    Reserved: USHORT,
...
STRUCT! {#[cfg_attr(feature = "logging", derive(Debug))]  struct TOKEN_PROCESS_TRUST_LEVEL {
    TrustLevelSid: PSID,
}}
