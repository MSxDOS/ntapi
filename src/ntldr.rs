...
STRUCT! {#[debug] struct LDR_DDAG_NODE {
    Modules: LIST_ENTRY,
...
STRUCT! {#[debug] struct LDR_DEPENDENCY_RECORD {
...
STRUCT! {#[debug] struct LDRP_LOAD_CONTEXT {
...
STRUCT! {#[debug] struct LDR_DATA_TABLE_ENTRY {
...
STRUCT! {#[debug] struct LDR_IMPORT_CALLBACK_INFO {
    ImportCallbackRoutine: PLDR_IMPORT_MODULE_CALLBACK,
    ImportCallbackParameter: PVOID,
}}
pub type PLDR_IMPORT_CALLBACK_INFO = *mut LDR_IMPORT_CALLBACK_INFO;
STRUCT! {#[debug] struct LDR_SECTION_INFO {
...
STRUCT! {#[debug] struct LDR_VERIFY_IMAGE_INFO {
    Size: ULONG,
    Flags: ULONG,
...
STRUCT! {#[debug] struct LDR_DLL_LOADED_NOTIFICATION_DATA {
    Flags: ULONG,
    FullDllName: PUNICODE_STRING,
    BaseDllName: PUNICODE_STRING,
    DllBase: PVOID,
...
STRUCT! {#[debug] struct LDR_DLL_UNLOADED_NOTIFICATION_DATA {
    Flags: ULONG,
...
STRUCT! {#[debug] struct LDR_RESOURCE_INFO {
    Type: ULONG_PTR,
    Name: ULONG_PTR,
    Language: ULONG_PTR,
}}
...
STRUCT! {#[debug] struct LDR_ENUM_RESOURCE_ENTRY_Path_s {
    Id: USHORT,
...
STRUCT! {#[debug] struct LDR_ENUM_RESOURCE_ENTRY {
...
STRUCT! {#[debug] struct RTL_PROCESS_MODULE_INFORMATION {
    Section: HANDLE,
    MappedBase: PVOID,
    ImageBase: PVOID,
    ImageSize: ULONG,
...
STRUCT! {#[debug] struct DELAYLOAD_PROC_DESCRIPTOR {
...
STRUCT! {#[debug] struct DELAYLOAD_INFO {
    Size: ULONG,
